...
// Generated for jankmonster oracle: each test body is a scenario, and the module under test is injected.
export const tests: [string, () => unknown][] = [];
const test = (name: string, body: () => unknown) => { tests.push([name, body]); };
let createPreparedContextNavigation!: typeof import('../prepared-context-navigation.mts').createPreparedContextNavigation;
export function useFactory(factory: typeof createPreparedContextNavigation) { createPreparedContextNavigation = factory; }
...
export const fixtures: ReturnType<typeof fixtureInner>[] = [];
function fixture(...args: Parameters<typeof fixtureInner>) { const created = fixtureInner(...args); fixtures.push(created); return created; }
function fixtureInner({ object = {}, imageLayerFrames = {}, volumeLensFrames = {}, volumeBank = null, deferredVolumeBank = null,
