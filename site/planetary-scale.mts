...
export function positionPlanetsByDistance<T extends { id: string; distanceAu: number }>(planets: readonly T[]) {
  ...
  const lastDistance = planets[planets.length - 1].distanceAu;
