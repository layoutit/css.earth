...
export interface ConformanceBrowserLaunchOptions {
...
export interface ConformanceBrowserLaunchResult {
  readonly options: LaunchOptions;
  readonly diagnostics: null | {
    readonly mode: "installed-chrome-with-retained-stdio";
    readonly executablePath: string;
    readonly wrapperPath: string;
    readonly stdioLogPath: string;
...
}: ConformanceBrowserLaunchOptions = {}): Promise<ConformanceBrowserLaunchResult> {
