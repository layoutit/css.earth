...
try {
 ...
 await page.evaluate(()=>{
  ...
  document.addEventListener('objectnavigate',event=>window.__labelNavigations.push(event.detail.objectId));
 });
 ...
 const body=await page.locator('.polycss-camera').boundingBox();
