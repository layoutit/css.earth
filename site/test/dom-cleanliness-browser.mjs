...
const output = resolve(process.env.CSSEARTH_DOM_CLEANLINESS_OUTPUT ?? 'output/dom-cleanliness');
assert.ok(output.startsWith(resolve('output') + '/'), 'DOM evidence must stay under output.');
