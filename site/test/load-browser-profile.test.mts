...
const sharedSettings = Object.freeze([{ name: "motion", kind: "toggle" }, { name: "minimap", kind: "toggle" }, { name: "planetaryLabels", kind: "toggle" }, { name: "heliosphere", kind: "toggle" }, { name: "illustrationModels", kind: "toggle" }]);
