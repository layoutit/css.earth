...
const sharedSettings = Object.freeze([{ name: "motion", kind: "toggle" }, { name: "skyContrast", kind: "toggle" }, { name: "minimap", kind: "toggle" }, { name: "heliosphere", kind: "toggle" }, { name: "illustrationModels", kind: "toggle" }, { name: "asteroidBodies", kind: "toggle" }, { name: "asteroidOrbits", kind: "toggle" }, { name: "asteroidLabels", kind: "toggle" }]);
