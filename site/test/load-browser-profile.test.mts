...
const sharedSettings = Object.freeze([{ name: "motion", kind: "toggle" }, { name: "skyContrast", kind: "toggle" }, { name: "heliosphere", kind: "toggle" }, { name: "asteroidOrbits", kind: "toggle" }, { name: "asteroidLabels", kind: "toggle" }]);
...
function snapshot(controls: FixtureControls = emptyControls) {
  ...
  return {
    ...
    settings: [sharedSettings[0],
      ...
      sharedSettings[1], sharedSettings[2], sharedSettings[3], sharedSettings[4],
