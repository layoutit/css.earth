...
export function bindViewUrl({ windowTarget, view, getMotion, setMotion, listenHistory = true, onError = () => {} }) {
  ...
  if (listenHistory) windowTarget.addEventListener("popstate", onPopState);
