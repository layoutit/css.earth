...
export const REFERENCES = Object.freeze(Object.fromEntries(EXPLORATION.catalog.references.map(record => [record.id, record])));
...
export const referenceUrl = (field: Cited<unknown>) => REFERENCES[field.referenceIds[0]].url;
