 ...
 * on its `#object-category-results` panel; both the browser and the no-JS
 * search function (`search-response.mts`) read it to fetch and verify the
 * same bytes before inserting the rows they describe.
 */
...
interface DatasetLike { catalogueSrc?: string; catalogueSha256?: string; catalogueBytes?: string; }
