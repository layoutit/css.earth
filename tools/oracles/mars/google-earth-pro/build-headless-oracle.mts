...
function addDylibLoadCommand(source: Buffer, installName: string) {
...
function patchBytes({ source, offset, expected, replacement, description }: { source: Buffer; offset: number; expected: Buffer; replacement: Buffer; description: string }) {
