...
import { GOOGLE_EARTH_PRO_MARS_ORACLE_PATCH } from "./api-contract.mts";
...
function replacePlistValue(plistPath: string, key: string, value: string) {
...
function replacePlistBoolean(plistPath: string, key: string, value: boolean) {
  execFileSync("/usr/bin/plutil", [
    "-replace",
    key,
    "-bool",
