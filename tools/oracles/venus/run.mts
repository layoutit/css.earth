...
import { compareOracleCaptures } from "./compare.mts";
import { GOOGLE_MAPS_VENUS_URL } from "./profile.mts";
...
function parseArguments(argumentsList: readonly string[]) {
  const options: { baseUrl?: string; outputRoot?: string; browserChannel?: string; referenceInput?: string } = {};
...
function requiredValue(argumentsList: readonly string[], index: number, flag: string) {
