...
const sampleGeo = (frame: ReturnType<typeof decodeOsirisGeo> & { quality?: { flags: ArrayLike<number>; allowLossy: boolean } }, matrix: number[][], pointKm: number[],
  ...
  image: { width: frame.width, height: frame.height, values: frame.planes.IMAGE, startTime: frame.startTime, filter: frame.filter, report: {},
    reject: i => !frame.quality || acceptOsirisQuality(frame.quality.flags[i], frame.quality.allowLossy) ? null : 'quality' },
