...
type FixturePin = { id: string; path: string; expectedSha256: string; expectedBytes: number; origin: string; credit: string; license: string; acquisition: string; consumers: string[] };
