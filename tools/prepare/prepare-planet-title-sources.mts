...
export async function preparePlanetTitleSources({
  ...
  writeSource = async (planet: TitleObject, moduleSource: string, source: PlanetTitleSource) => {
...
export function createPlanetTitleSource(label: string, font: Pick<fontkit.Font, "layout" | "unitsPerEm">) {
...
export function serializePlanetTitleSource(exportName: string, source: PlanetTitleSource) {
