...
const root = process.cwd(); const sourceDirectory = resolve(root, 'src/planets', id, 'source');
...
console.log(JSON.stringify({ id, sky: result.sky.schema, sun: result.sun.schema, markers: result.markers.schema }));
