...
export const parseLayeredLenses = shape({defaultLens:text,controls:array(shape({id:text,materialLens:text,view:optional(text),
  surfaceUrl:optional(text),polesUrl:optional(text),ringUrl:optional(text)}))});
export const parseLayeredAtlas = shape({variants:dictionary(shape({runtimeAtlas:shape({assetUrl:text}),
