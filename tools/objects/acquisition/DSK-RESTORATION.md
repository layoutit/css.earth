...
The actual corrected-v2 source conversion and the empty-destination repeat both passed. The [original restoration receipt](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/moons/b2-preparation/final/fresh-source-restoration.json) records the downloaded DSK, converter/toolchain identity and derivative hashes. Fixture tests remain separate from that actual-source evidence.
