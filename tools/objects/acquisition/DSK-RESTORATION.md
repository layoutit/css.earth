...
The actual corrected-v2 source conversion and the empty-destination repeat both passed. The B2 fresh source restoration receipt in `docs/moons/b2-preparation/final/fresh-source-restoration.json` records the downloaded DSK, converter/toolchain identity and derivative hashes. Fixture tests remain separate from that actual-source evidence.
