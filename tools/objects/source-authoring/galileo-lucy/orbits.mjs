...
import { evaluatePublishedOrbit } from '../../../../packages/astronomy/tools/body-epoch-ephemeris.mjs';
import { bodies, celestiaCommit, celestiaUrl } from './catalog.mjs';
...
const eclipticPoleToIcrf = (longitude, latitude) => {
...
for (const body of bodies) {
  ...
  const bytes = await readFile(`${s}/orbit/published-parameters.json`), state = evaluatePublishedOrbit(parameters, epochJdTt);
