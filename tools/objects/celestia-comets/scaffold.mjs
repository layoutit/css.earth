...
for(const c of intake){
 ...
 const descriptor=await clone('object.json');delete descriptor.properties.worldFrame;delete descriptor.prepared;delete descriptor.properties.page.metadata;descriptor.properties.preparation.label=name;descriptor.properties.recipe.shape.radiusKm=model.volumeEquivalentRadiusKm;await write(`${p}/object.json`,descriptor);
