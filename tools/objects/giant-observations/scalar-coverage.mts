export interface ScalarSource {width: number; height: number; values: Float32Array | Float64Array | readonly number[]; missing?: Uint8Array;}
import { polarZeroCoverage } from '../observed-coverage.mts';
...
export function finitePercentiles(values: ScalarSource['values'], lower: number, upper: number,minimumCoverageFraction: number, missing?: Uint8Array): [number, number] {
...
function samplePalette(palette: readonly (readonly number[])[], amount: number) {
