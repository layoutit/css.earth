 ...
 *
 *   node tools/objects/interferometry/calibrate-matisse.mts <science dp_id> <work directory> [--raw <directory>]
 *
 ...
 * state; the calibrator exposure in that state nearest in time is reduced the same way, and mat_cal_oifits calibrates. The
