...
import { pageCoordinates, prepareLocationPoint, prepareLocationCamera } from "./prepare-location.mjs";
...
export async function preparePlaces({sourceDirectory,publicDirectory,config,scene}) {
