...
export function prepareAdministrativePlaces({ countryRows, adminRows, records, legacyCountryFeatures, countryFeatures, adminFeatures, scene, cameraOptions }) {
  ...
  function navigation(row, geometry, geometrySource, legacyPoint) {
    ...
    return { latitude, longitude,
      camera: prepareLocationCamera(scene, prepareLocationPoint(scene, longitude, latitude), zoom, cameraOptions), coverage: "overview",
