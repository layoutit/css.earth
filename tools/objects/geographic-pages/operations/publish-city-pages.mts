#!/usr/bin/env node
import { parseCitySource, array, text } from '../source-records.mts';
...
const CITY_ASSET_URLS=array(text)(JSON.parse(await readFile(resolve(root,`output/${context.objectId}-city`,source.dataset,"assets.json"),"utf8")));
