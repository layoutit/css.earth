...
import { CITY_PAGE_PIXELS, pageKey } from '../page-geometry.mjs';
...
const fixture=JSON.parse(await readFile(resolve(root,`output/${context.objectId}-city`,pin.dataset,'manifest.json'),'utf8'));
