...
import { coverageLookup,prepareTreeSection,prepareTileNode,childrenOf,hashBytes,tileKey } from "../prepare-wmts-tree.mjs";
import { encodePreparedBlock } from "../encode-prepared-block.mjs";
import { prepareWmtsTile } from "../wmts-page-geometry.mjs";
import { PREPARED_BLOCK_ENCODING } from "../../../../src/platform/prepared-map/prepared-block-transport.mjs";
import {commandContext} from './context.mjs';

export async function finalizeGlobalWmts(directory,{context,verify=true}={}){
