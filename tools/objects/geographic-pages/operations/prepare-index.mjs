...
export function prepareCityIndex(pages, dataset, scene, delivery) {
  const nodes = new Map(pages.map(page => [page.key, { ...page }]));
  ...
  const descriptor = (node) => ({ key: node.key, level: node.level, corners: node.corners,
