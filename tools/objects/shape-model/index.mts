...
export function prepareRingLeaves(config:ShapeModelConfig, texture:{url:string;width:number;height:number}, majorRadiusKm:number, onGeometry?:(geometry:NonNullable<ReturnType<typeof resolvePolyTextureLeafGeometry>>)=>void) {
  ...
  return Array.from({ length: segments }, (_, i) => {
    ...
    const plan = computeTextureAtlasPlanPublic(polygon, i, { tileSize: 50, layerElevation: 50, seamBleed: 0 });
