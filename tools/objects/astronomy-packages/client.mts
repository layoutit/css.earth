...
function uvfitsRequest(request: PyuvdataUvfitsRequest): PyuvdataUvfitsRequest {
  const file = parsePin(request.file); if (!['uvfits-visibility-inspect', 'uvfits-visibility-export', 'uvfits-amplitude-phase-diagnostics', 'uvfits-uv-coverage-diagnostics'].includes(request.operation)) throw new TypeError('Unsupported pyuvdata UVFITS operation.');
