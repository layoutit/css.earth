...
import {CUBIC_SKY_STANDARD} from '../../../src/platform/cubic-sky-contract.mjs';
import {prepareEllipsoidMaterialPlaneTransform} from './material-plane.mjs';

export async function prepareAffineCamera({config,geometry,scene,lighting,contract,outputDirectory}) {
