...
export function ellipsoidParameterMesh(model) {
...
export async function loadEllipsoidParameters(path, profile) {
...
export function subdividedOctahedron(subdivisions) {
