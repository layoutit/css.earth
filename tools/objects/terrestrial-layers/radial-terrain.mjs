...
export async function prepareRadialMaterials({ radial, surfaces, config, source, publicDirectory, outputDirectory, sunDirection,
  ...
  for (const surface of surfaces) {
    ...
    const encoding = scalarSources || scientific?.format === 'image-plane-dem' ? { lossless: true, effort: 4 } : { quality: config.raster.surfaceQuality ?? 90, alphaQuality: 100, effort: 4 };
