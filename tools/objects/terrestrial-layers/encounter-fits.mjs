...
export function readEncounterHdus(bytes) {
  ...
  while (start < bytes.length) {
    ...
    if (end < 0 || header.NAXIS !== 2 || !integer(width, 1, 4096) || !integer(height, 1, 4096) ||
        ![8, -32].includes(bitpix) || (hdus.length ? header.XTENSION !== 'IMAGE' || header.PCOUNT !== 0 || header.GCOUNT !== 1 : header.SIMPLE !== true)) {
...
export function decodeEncounterFits(bytes, policy) {
