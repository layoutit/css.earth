...
export const parseRadialSource = shape({format:optional(text),path:text,grid:requireRecord,faceBudget:number,texelsPerFace:number,interiorSlices:optional(boolean),
