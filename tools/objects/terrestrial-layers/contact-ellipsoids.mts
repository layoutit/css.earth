...
export function contactEllipsoidMesh(value: unknown) {
  const model=parseContactModel(value);
...
export async function loadContactEllipsoids(path: string, value: unknown) {
