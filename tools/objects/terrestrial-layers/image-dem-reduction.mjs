...
const projectedArea = (face, positions) => {
...
export function repairImageDemDiagonals(input, positions) {
...
export function measureImageDemReduction(source, flatIndices, maximumDistanceMeters) {
