...
export function prepareLenses(
  objectId: string,
  recipe: { title: { label: string; src: string; width: number; height: number }; defaultLens: string; geographicCapacity?: number; controls: LensRecipe[] },
  ...
  return {
    ...
    ...(recipe.geographicCapacity === undefined ? {} : { geographicCapacity: recipe.geographicCapacity }),
