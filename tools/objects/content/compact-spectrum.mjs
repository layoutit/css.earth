...
export function renderCompactSpectrum({ title, description, metadata, points, maximum }) {
  ...
  const y = value => 64 - value / maximum * 55;
...
${[[.35,'350','start'],[.55,'550','middle'],[.75,'750','middle'],[1,'1000 nm','end']].map(([wavelength,label,anchor]) => `<text x="${x(wavelength)}" y="89" fill="#888" text-anchor="${anchor}">${label}</text>`).join('\n')}
</svg>`;
}
