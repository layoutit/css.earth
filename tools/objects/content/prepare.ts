...
export function prepareObjectContent(
  ...
  return {
    ...
    lenses: prepareLenses(source.id, {
      ...
      geographicCapacity: source.lenses.geographicCapacity,
...
export async function prepareObjectContentAssets({
  ...
  const shellLenses = {
    ...
    ...(preparedWithAssets.lenses.geographicCapacity === undefined ? {} : { geographicCapacity: preparedWithAssets.lenses.geographicCapacity }),
