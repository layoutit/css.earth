import { blackFillCoverage, paintMissingCoverage } from '../../src/platform/prepare-missing-coverage.mjs';
...
export function polarZeroCoverage(data, info) {
  return blackFillCoverage(data, info, { northConnected: true, southConnected: true });
}

function bilinear(source, x, y, respectCoverage) {
...
export function resizeObservedRgb(source, width, height) {
...
export function prepareMeasuredPolarAtlas(source, tileSize, {
