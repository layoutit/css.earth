...
test('descriptor retains planetary depth meaning and refuses unsupported conversions or coverage',()=>{
  ...
  assert.equal(parsed.components[0]?.placement?.kind,'located-profile');
