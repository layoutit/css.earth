 ...
 * `@cssearth/bake/raster`, as were the scene compilers (`src/renderers/css/preparation/scene/`, `src/platform/`) before
 * `@cssearth/bake/scene`; following them keeps every operation identified by the code it ran. Other packages stay external, as they always were. */
