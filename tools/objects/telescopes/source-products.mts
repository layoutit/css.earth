...
export const SOURCE_RUN_FILES = ['source-intake.mts', 'source-product-contract.mts', 'source-transfer.mts', '../operations-acquisition.ts', '../source-files.ts', '../terrestrial-layers/isis3-raster.mts', 'source-products.mts', 'qualify-source.mts', 'observation-families.mts', 'product-descriptor.mts', 'families/common.mts', 'families/f16/f16-spherical-grid.mts', 'native-metadata.mts', 'product-science.mts', 'calibration-dependencies.mts', '../astronomy-packages/science.mts', '../astronomy-packages/requirements.lock', 'qualified-observations.mts', 'request-satisfaction.mts', '../../../packages/fits/src/fits.ts', '../../../packages/fits/src/node/file.ts', '../../../packages/fits/src/rice.ts', '../../../packages/telescope/src/pds3-labels.ts', '../pds/source-observations.mts', '../../../packages/telescope/src/pds-labels.ts', '../../../packages/telescope/src/product-record.ts', '../../../packages/telescope/src/node/product-record.ts', '../astronomy-packages/pds-client.mts', '../astronomy-packages/pds-toolchain.json'] as const;
