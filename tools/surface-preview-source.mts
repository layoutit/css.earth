...
export const parsePreviewSurface=(value:unknown)=>Object.assign({},requireRecord(value),shape({id:text,map:optional(shape({url:text})),source:optional(value=>typeof value === 'string' ? value : requireRecord(value))})(value));
