...
What Hubble's public archive holds, what this repository can re-calibrate from raw, and which of the objects it ships Hubble has observed. Written by [`archive-ledger.mts`](../tools/objects/hst/archive-ledger.mts) from MAST on 2026-09-19; the route it checks is [Hubble](hubble.md).
...
| --- | ---: | ---: | --- | --- |
| ACS/WFC | 174,029 | 482 | wide-field pictures, 0.35–1.1 µm | no |
| ACS/HRC | 35,937 | 2,234 | high-resolution pictures and slitless spectra | Not run here; the detector stopped working in 2007. |
| ACS/SBC | 9,540 | 885 | far-ultraviolet pictures and prism spectra | europa-11085 |
| WFC3/UVIS | 206,612 | 23,542 | pictures, 0.2–1 µm | europa-15419 |
| WFC3/IR | 256,117 | 1,046 | pictures and slitless spectra, 0.8–1.7 µm | calwf3 handles it; no IR exposure has been re-calibrated here. |
| STIS/CCD | 210,165 | 4,226 | spectra and pictures, 0.2–1 µm | europa-14650, europa-15419 |
| STIS/NUV-MAMA | 12,742 | 483 | near-ultraviolet spectra and pictures | calstis handles it; no NUV exposure has been re-calibrated here. |
| STIS/FUV-MAMA | 14,982 | 1,743 | far-ultraviolet spectra and pictures | europa-13040 |
| STIS | 8,164 | 145 | co-added spectra the archive builds from several visits (HASP) | A product of products; there is no raw exposure to re-calibrate. |
| COS/FUV | 27,302 | 193 | far-ultraviolet point-source spectra | calcos is not installed. |
| COS/NUV | 13,863 | 289 | near-ultraviolet point-source spectra | calcos is not installed. |
| WFPC2/PC | 202,677 | 8,746 | pictures on the planetary camera, 1994–2009 | calwp2 is retired and not in hstcal. |
| WFPC2/WFC | 20,292 | 2,327 | pictures on the three wide-field chips | calwp2 is retired and not in hstcal. |
| WFPC2 | 35,523 | 0 | WFPC2 products the catalogue does not assign to a chip | no |
| NICMOS/NIC1 | 26,812 | 398 | near-infrared pictures at the finest sampling | calnica is retired and not in hstcal. |
| NICMOS/NIC2 | 40,531 | 903 | near-infrared pictures and coronagraphy | calnica is retired and not in hstcal. |
| NICMOS/NIC3 | 47,611 | 120 | near-infrared pictures and grism spectra | calnica is retired and not in hstcal. |
| FOC/96 | 5,441 | 249 | faint-object camera pictures, 1990–2002 | Its pipeline is retired. |
| FOC/48 | 1,254 | 4 | faint-object camera pictures in its other format | Its pipeline is retired. |
| FOS/BL | 11,180 | 579 | faint-object spectrograph, blue detector, 1990–1997 | Its pipeline is retired. |
| FOS/RD | 12,200 | 599 | faint-object spectrograph, red detector, 1990–1997 | Its pipeline is retired. |
| WFPC/PC | 9,520 | 463 | the first wide-field camera, 1990–1993 | Its pipeline is retired. |
| ACS | 12,218 | 0 | ACS products the catalogue does not assign to a detector | no |
| COS-STIS | 875 | 0 | co-added spectra the archive builds from COS and STIS visits together (HASP) | A product of products. |
| COS | 8,247 | 77 | COS products the catalogue does not assign to a detector | no |
| HRS | 3,703 | 177 | the Goddard high resolution spectrograph, 1990–1997 | Its pipeline is retired. |
| HRS/1 | 6,424 | 710 | the same spectrograph on its first detector | Its pipeline is retired. |
| HRS/2 | 14,122 | 610 | the same spectrograph on its second detector | Its pipeline is retired. |
| HSP/UNK/POL | 1,505 | 12 | the high speed photometer, polarimetry, 1990–1993 | no |
| HSP/UNK/UV1 | 1,025 | 0 | the high speed photometer, first ultraviolet channel | no |
| HSP/UNK/UV2 | 1,064 | 0 | the high speed photometer, second ultraviolet channel | no |
| HSP/UNK/VIS | 687 | 52 | the high speed photometer, visible channel | no |
| WFPC/WFC | 6,226 | 93 | the first wide-field camera, wide-field chips | Its pipeline is retired. |
| FGS | 53,439 | 0 | fine guidance sensor astrometry and interferometry | no |

Re-calibrated and checked against the archive's own product: ACS/SBC (europa-11085); WFC3/UVIS (europa-15419); STIS/CCD (europa-14650, europa-15419); STIS/FUV-MAMA (europa-13040). Every other configuration is counted here and nothing more.
