...
The current source-qualified total is **34 places**: 28 on 67P (26 new SHAP7
regions and two existing Philae sites), one on Tempel 1, three on Hartley 2,
and two inferred-anatomy points on Tuttle’s default model. “Accepted” in
...
| `comet-19p` | [Borrelly PDS DEM](https://pdssbn.astro.umd.edu/holdings/ds1-c-micas-5-borrelly-dem-v1.0/); [package README](../../src/planets/comet-19p/README.md) | **Not qualified:** prior loose crop resizing did not prove 2D registration; candidate terrain/orthophoto places are not accepted. |
...
| `comet-81p` | [Wild 2 PDS shape model](https://pdssbn.astro.umd.edu/holdings/sdu-c-navcam-5-wild2-shape-model-v2.1/); [package README](../../src/planets/comet-81p/README.md) | **Not qualified:** matching phase did not prove the same image ID; individual feature candidates are not accepted. |
