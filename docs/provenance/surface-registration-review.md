...
| --- | ---: | --- |
| Object directories under `src/objects` | 477 | 473 registered packages plus the four README-only stubs. |
...
| Pallene | The pinned calibrated source is only 8 × 13 illuminated pixels at the accepted thresholds and contains no independently identifiable surface feature. The direct check is recorded in [`registration-attempt-2026-09-10.json`](../../src/objects/pallene/source/survey/registration-attempt-2026-09-10.json). |
...
| `comet-109p` | [package source record](../../src/objects/comet-109p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared illustrative mesh and fixed illustrative attitude have no body frame or terrain. |
| `comet-137p` | [package source record](../../src/objects/comet-137p/source/reference/source-record.json); [Donaldson 2025 thesis](https://era.ed.ac.uk/items/cf7f5ebf-4f32-4f86-95d2-b8dd2e37c8ad) | No anchor: convex inversion gives shape and pole, not a public mesh, longitude origin, or mapped terrain. |
| `comet-143p` | [package source record](../../src/objects/comet-143p/source/reference/source-record.json); [Donaldson 2025 thesis](https://era.ed.ac.uk/items/cf7f5ebf-4f32-4f86-95d2-b8dd2e37c8ad) | No anchor: the convex model has no registered longitude or surface-feature coordinates. |
| `comet-153p` | [package source record](../../src/objects/comet-153p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: illustrative shared mesh, with no measured attitude or terrain. |
| `comet-162p` | [package source record](../../src/objects/comet-162p/source/reference/source-record.json); [Donaldson 2025 thesis](https://era.ed.ac.uk/items/cf7f5ebf-4f32-4f86-95d2-b8dd2e37c8ad) | No anchor: tentative bilobate anatomy from planar convex-model facets is not mapped geography. |
| `comet-167p` | [package source record](../../src/objects/comet-167p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: catalog size and illustrative mesh supply no measured surface frame. |
| `comet-17p` | [package source record](../../src/objects/comet-17p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: the outburst is coma history; the nucleus is illustrative and unregistered. |
| `comet-19p` | [Britt et al. 2004, Figs. 1 and 4](https://doi.org/10.1016/j.icarus.2003.09.004); original MICAS orthophoto/XYZ cubes; [package README](../../src/objects/comet-19p/README.md) | **4 mapped-terrain places:** upper/lower mottled terrain, central mesas and central smooth terrain. Two image registrations use independent withheld controls before native XYZ lookup. Approximate interiors, MICAS view only; lower smooth terrain remains withheld near the image edge. |
| `comet-1p` | [package Giotto registration record](../../src/objects/comet-1p/source/reference/giotto-registration.json); [Halley PDS search](https://sbnapps.psi.edu/ferret/SimpleSearch/results.action?targetName=1P%2FHalley+1) | No terrain anchor: current Giotto and Vega directions are observation areas, not registered feature intercepts in the selected frame. |
| `comet-209p` | [package source record](../../src/objects/comet-209p/source/reference/source-record.json); [Schleicher & Knight 2016](https://arxiv.org/pdf/1605.01705) | No anchor: radar supplies overall dimensions only; the ellipsoid orientation is illustrative. |
| `comet-21p` | [package source record](../../src/objects/comet-21p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: the ICE tail encounter did not map the nucleus; mesh and attitude are illustrative. |
| `comet-26p` | [package source record](../../src/objects/comet-26p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: Giotto encounter context does not provide a nucleus surface frame. |
| `comet-29p` | [package source record](../../src/objects/comet-29p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: coma jets do not map to the illustrative nucleus. |
| `comet-2p` | [package source record](../../src/objects/comet-2p/source/reference/source-record.json); [Harmon & Nolan 2005](https://doi.org/10.1016/j.icarus.2005.01.012) | No anchor: radar-constrained ellipsoid axes have an illustrative attitude and no terrain coordinate system. |
| `comet-46p` | [package source record](../../src/objects/comet-46p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: mission history does not resolve terrain on the illustrative nucleus. |
| `comet-55p` | [package source record](../../src/objects/comet-55p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: meteor-stream context supplies no nucleus surface frame. |
| `comet-67p` | [SHAP7 regions](https://doi.org/10.17632/2845znt54k.1); [package landmarks](../../src/objects/comet-67p/source/features/landmarks.json) | **28 accepted:** 26 SHAP7 regions plus the two existing Philae sites; registered to the package’s mapped shape sources. |
| `comet-81p` | [NASA PIA06285](https://science.nasa.gov/photojournal/wild-2-close-look/); [Brownlee et al. 2004, Fig. 2](https://doi.org/10.1126/science.1097899); native N2073 FITS and full PDS shape; [package README](../../src/objects/comet-81p/README.md) | **3 named depressions:** Mayo, Left Foot and Right Foot. Interior photo matches establish correspondence with N2073; camera rays intersect observed source faces. Approximate locations; Hemenway/Rahe remain too sensitive, and Shoemaker/Walker callouts project to estimated terrain. |
| `comet-8p` | [package model record](../../src/objects/comet-8p/source/shape/model.json); [Groussin et al. (2019)](https://arxiv.org/abs/1911.04897) | **2 inferred-anatomy points:** large and small lobes in the default model; neither is observed terrain. Browser inspection rejected the contact label because the nearer lobe hides it after the camera approaches. |
| `comet-96p` | [package source record](../../src/objects/comet-96p/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: solar-observatory context does not register the illustrative nucleus. |
| `comet-9p` | [Tempel 1 PDS shape](https://pdssbn.astro.umd.edu/holdings/dif-c-hriv_its_mri-5-tempel1-shape-v2.0/dataset.shtml); [package photography note](../../src/objects/comet-9p/source/reference/encounter-photography.md) | **1 qualified site:** Deep Impact, approximately 16° E, 28° S in the PDS 2012 frame. Photograph registration is a separate qualification. |
| `comet-c1956-r1` | [package source record](../../src/objects/comet-c1956-r1/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: historical appearance does not locate terrain on the illustrative mesh. |
| `comet-c1973-e1` | [package source record](../../src/objects/comet-c1973-e1/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: historical appearance does not locate terrain on the illustrative mesh. |
| `comet-c1983-h1` | [package source record](../../src/objects/comet-c1983-h1/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: discovery history does not locate terrain on the illustrative mesh. |
| `comet-c1995-o1` | [package source record](../../src/objects/comet-c1995-o1/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared procedural mesh and fixed attitude have no terrain correspondence. |
| `comet-c1996-b2` | [package source record](../../src/objects/comet-c1996-b2/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared procedural mesh and fixed attitude have no terrain correspondence. |
| `comet-c2006-p1` | [package source record](../../src/objects/comet-c2006-p1/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared procedural mesh and fixed attitude have no terrain correspondence. |
| `comet-c2013-a1` | [package source record](../../src/objects/comet-c2013-a1/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared procedural mesh and fixed attitude have no terrain correspondence. |
| `comet-c2014-un271` | [package source record](../../src/objects/comet-c2014-un271/source/reference/source-record.json); [ALMA coma study](https://ntrs.nasa.gov/api/citations/20250006397/downloads/UN271_ALMA_ApJL_aasv7_Accepted.pdf) | No anchor: the study concerns coma gas and the displayed rough sphere is illustrative. |
| `comet-c2020-f3` | [package source record](../../src/objects/comet-c2020-f3/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared procedural mesh and fixed attitude have no terrain correspondence. |
| `comet-c2023-a3` | [package source record](../../src/objects/comet-c2023-a3/source/reference/source-record.json); pinned [Celestia catalog](https://github.com/CelestiaProject/CelestiaContent/blob/1993a082ee6307c0df7fdc0828eb117a0e8e9958/data/comets.ssc) | No anchor: shared procedural mesh and fixed attitude have no terrain correspondence. |
