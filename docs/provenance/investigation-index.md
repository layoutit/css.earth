...
**Ledgers:** 542 of 568 catalogued objects.
**Open decisions:** 1072 (941 unresolved, 131 deferred).
...
| doi.org | 50 | bienor, braille, ce-tauri, chariklo, chiron, comet-1p, +31 more |
| sbnarchive.psi.edu | 30 | atlas, comet-109p, comet-153p, comet-167p, comet-17p, comet-21p, +24 more |
...
| `dawn-vir-band-centers` | 1 | ceres | A lens for band position is wanted and a published color scale for the band-center maps is found, for example in Frigeri et al. (2019). |
...
| `jiram-orbits-51-to-60` | 1 | io | The mosaic tool fits the limb with Io's ellipsoid and the orbits 51 to 60 frames are screened. |
...
(643 with the excluded decisions, which the ledger test tracks). Give each one the archive,
