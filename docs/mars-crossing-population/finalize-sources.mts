...
const bodies=parseBodies(await json(args.find(a=>a.endsWith('.json')) ?? 'docs/mars-crossing-population/inputs.json')).filter(b=>!args.some(a=>a.startsWith('--object='))||args.includes('--object='+b.id));
