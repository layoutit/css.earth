...
const bodies=JSON.parse(await readFile('docs/mars-crossing-population/inputs.json','utf8'));
const fixtures={};
...
await writeFile('docs/mars-crossing-population/orbit-errors.json',JSON.stringify(records,null,2)+'\n');
