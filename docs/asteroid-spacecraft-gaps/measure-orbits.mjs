...
const bodies=JSON.parse(await readFile('docs/asteroid-spacecraft-gaps/inputs.json','utf8')).bodies;
const fixtures={};
...
await writeFile('docs/asteroid-spacecraft-gaps/orbit-errors.json',JSON.stringify(records,null,2)+'\n');
