...
node docs/lucy-targets/navigation.mts --base=7ae81ba2d366ef20d1687a6eec51c2106be1e1b4 --inputs=docs/non-belt-populations/inputs.json --evidence=docs/non-belt-populations/navigation-evidence.json
node docs/non-belt-populations/refresh-transports.mts
