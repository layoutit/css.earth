...
const { bodies } = JSON.parse(await readFile('docs/trans-neptunian/inputs.json'));
...
for (const b of bodies) {
  ...
  if (!refreshOnly) {
    ...
    const recipe={generator:'tools/objects/terrestrial-layers/radial-snapshot.mjs',inputs:['published-shape','model-surface'],size:512,longitudeDegrees:55,latitudeDegrees:b.id==='arrokoth'?-25:20,ambient:.45,diffuse:.55,lensId:'model'};
