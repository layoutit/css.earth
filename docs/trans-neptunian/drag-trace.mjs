...
const id = process.argv[5] ?? 'arrokoth';
assert.ok(OBJECTS.some(object => object.id === id && object.classification === 'trans-neptunian'));
...
const output = resolve(process.argv[4] ?? `output/playwright/trans-neptunian/drag-${id}-dpr${dpr}`);
