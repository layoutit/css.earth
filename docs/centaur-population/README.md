...
```sh
node docs/lucy-targets/author.mts --inputs=docs/centaur-population/inputs.json
node packages/astronomy/tools/generate-asteroids.mts --object=chariklo --object=bienor
node docs/centaur-population/author-details.mts
node docs/lucy-targets/author.mts --inputs=docs/centaur-population/inputs.json --refresh-pins
...
node docs/lucy-targets/navigation.mts --base=bd265cf3a091c4ef17e9be76dfeb23410364884f --inputs=docs/centaur-population/inputs.json --evidence=docs/centaur-population/navigation-evidence.json
node docs/centaur-population/refresh-presentations.mts
node docs/centaur-population/refresh-transports.mts
node docs/centaur-population/integrate-context.mts
node tools/prepare-object-json.mts sun
