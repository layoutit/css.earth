...
node docs/moons/b10-lunar-thermal/configure.mjs
node docs/moons/b10-lunar-thermal/prepare-selected.mjs
node docs/moons/b10-lunar-thermal/finalize-one.mjs moon
```
