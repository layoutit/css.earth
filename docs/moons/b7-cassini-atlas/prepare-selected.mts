...
const id=(Object.keys(selections) as Array<keyof typeof selections>).find(id=>id===process.argv[2]);if(!id)throw new Error('Specify one B7 body.');
...
console.log('Asset stage complete; finalize transport in a fresh process: node docs/moons/b7-cassini-atlas/finalize-one.mts '+id);
