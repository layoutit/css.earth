...
const ids=['tethys','iapetus','phoebe'],base=process.env.B9_QUALIFICATION_BASE ?? '80e19c51349f713c9a9a64b8ef1cbb78917f0fc7';
...
await mkdir('output/b9-qualification',{recursive:true});
await writeFile('output/b9-qualification/packages.json',JSON.stringify(report,null,2)+'\n');
