...
const id=process.argv[2];if(!selections[id])throw new Error('Specify one B8 body.');
...
console.log('Asset stage complete; finalize transport in a fresh process: node docs/moons/b8-surface-chemistry/finalize-one.mjs '+id);
