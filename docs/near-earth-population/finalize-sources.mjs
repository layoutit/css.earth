...
const bodies=(await json(args.find(a=>a.endsWith('.json')) ?? 'docs/near-earth-population/inputs.json')).filter(b=>!args.some(a=>a.startsWith('--object='))||args.includes('--object='+b.id));
