...
const bodies=JSON.parse(await readFile('docs/near-earth-population/inputs.json','utf8'));
const fixtures={};
...
await writeFile('docs/near-earth-population/orbit-errors.json',JSON.stringify(records,null,2)+'\n');
