...
| --- | --- |
| Shape and spin | [DAMIT 1163](https://damit.cuni.cz/projects/damit/asteroid_models/view/1163) |
...
The [dresda results](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **83.01 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; neutral gray marks that gap. Alternative archive solutions: model 1164, pole ['272', '61'], [Model 1164](https://damit.cuni.cz/projects/damit/asteroid_models/view/1164)
...
The original +Z spin axis and +X reference meridian are retained. The source pole is ecliptic J2000 (99°, 54°), with sidereal period 16.8138 h. Conversion to equatorial J2000 uses obliquity 23.439291111°. Position uses JPL Horizons heliocentric ICRF elements at 2026-09-03 TT (TDB approximated as TT, under 2 ms).
...
The established source-meshoptimizer path retains source connectivity, reduces to at most 800 faces, and emits native PolyCSS `u` triangles with 128 px raster cells. The error allowance is 257.4 m; sampled source-fit error is qualified separately from source accuracy.
