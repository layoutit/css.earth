...
- **Voyager ISS photographic products:** [PDS archive](https://pds-rings.seti.org/voyager/iss/), surveyed in OPUS by Desdemona center sampling. Center-resolution metadata alone does not qualify a surface. A separate non-null surface-intersection query returns 0 observations.
