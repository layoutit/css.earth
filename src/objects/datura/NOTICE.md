# (1270) Datura: attribution and reuse

The selected geometry and spin originate from [DAMIT model 266](https://damit.cuni.cz/projects/damit/asteroid_models/view/266), version 2009-06-15, credited to Vokrouhlický et al. (2009), A&A 507, 495 and the contributing observers cited by that record. DAMIT distributes its database under [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/) as stated in the archived model page. Preserve attribution, source links and notice of changes.
