...
Illustration lens: base-colour texture of the Makemake 3D Model by NASA Visualization Technology Applications and Development (VTAD), https://science.nasa.gov/resource/makemake-3d-model/, used unchanged under NASA's media guidelines (https://www.nasa.gov/nasa-brand-center/images-and-media/). An artist's illustration, not an observation.
...
Title typography: Inter Variable, SIL Open Font License, with pinned provenance in `source/presentation/title-mark.json`.
