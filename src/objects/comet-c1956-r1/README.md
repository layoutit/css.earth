...
One **Shape approximation** dataset shows a sphere at an assumed radius of 1.165 km; no published nucleus size exists. The whole surface carries the missing-imagery grid. Shadows defaults off.
