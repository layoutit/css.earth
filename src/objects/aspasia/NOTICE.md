# (409) Aspasia: attribution and reuse

The selected geometry and spin originate from [DAMIT model 715](https://damit.cuni.cz/projects/damit/asteroid_models/view/715), version 2017-06-19, credited to Hanuš et al. (2017), A&A 601, A114; Hanuš et al. (2013), Icarus 226, 1045 and the contributing observers cited by that record. DAMIT distributes its database under [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/) as stated in the archived model page. Preserve attribution, source links and notice of changes.
...
Physical-size credit: [DAMIT model 715 calibrated size, Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/asteroid_models/view/715). JPL Small-Body Database and Horizons records are credited to NASA/JPL. Article PDFs and reference documents retain their own publication notices; the DAMIT CC BY license does not override those notices.
