...
The 13 September 2026 integration prepared result `cd1f89e3e0affb327370338346df7f5812c0109ebd46cffeb9c8f702b94ed70c`, with five lenses, 450 shared lights and 847 nonempty slices per lens. This is the new compiled delivery, distinct from the historical `4510c5bb…` comparison. Source-card validation checked all five bindings and the installed bank identity; this does not establish a new visual acceptance or a clean-cache NOX replay.
