...
- Semiaxes are 32 × 23 × 23 km.

## Evidence

- The finest candidate vg-iss-2-u-c2678925 lists 23.54635 km/native pixel, but has no recorded Bianca surface intersection or located pixel center. Its actual GEOMED raster and label were inspected.

## Known problems

- The third axis repeats the minor axis by the published prolate assumption. This is an analytic approximation, not a detailed measured terrain mesh. The reported projected radius is 27 ± 2 km and minor/major ratio 0.7 ± 0.2; these are not separate-axis error bars.
...
- The shared display then advances the secular spin rate -828.391476°/day and freezes the small periodic correction. This is not a complete long-term rotation ephemeris or landmark registration.
...
Physical scale uses the derived volume-equivalent radius 25.67646409198381 km, preserving the stated axes.

## Source survey and lens decisions

- **Voyager ISS photographic products:** [PDS archive](https://pds-rings.seti.org/voyager/iss/), surveyed in OPUS by Bianca center sampling. Center-resolution metadata alone does not qualify a surface. A separate non-null surface-intersection query returns 2 observations, with best listed sampling 107.38621 km/pixel.
...
NASA/NAIF PCK00011 BODY708 supplies the pole and prime meridian. SPICE evaluates its full periodic terms at JD 2461286.5 TT: RA 257.35647418354256°, Dec -15.333101764405413°, W 89.90817800997476°. Obsolete spherical PCK radii are not used.
