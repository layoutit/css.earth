...
The Callisto photographic starfield uses the 6000 x 3000 public equirectangular
...
single-epoch Callisto sky. The prepared Callisto scene therefore uses the image
...
not add or bake a Sun. The complete ESO credit is exposed in Callisto's source
resources.

## Astrometric registration (Callisto)
