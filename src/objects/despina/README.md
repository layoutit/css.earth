...
Common sky and title inputs retain their own pins and attribution: ESO/S. Brunier Milky Way panorama under CC BY 4.0; HYG catalog under its bundled license; Inter font under SIL OFL 1.1. Required source inputs are checked in or restored by `source/preparation/acquisition.json`; prepared runtime assets install separately.
