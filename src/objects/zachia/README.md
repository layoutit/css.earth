...
| --- | --- |
| Shape and spin | [DAMIT 5901](https://damit.cuni.cz/projects/damit/asteroid_models/view/5901) |
| Physical scale | [Calibration and uncertainty](source/reference/calibration.json) |

[DAMIT model 5901](https://damit.cuni.cz/projects/damit/asteroid_models/view/5901), version 2019-10-23, from Ďurech et al. (2020), is a convex lightcurve inversion mesh. The original 552 vertices and 1100 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness.

Concavities, craters, surface texture and exact current rotation phase are not resolved.

Adopted diameter: **16.848 ± 0.182 km**, meaning **effective body diameter**, from [Masiero et al. (2014), PDS NEOWISE Diameters and Albedos V2.0, reference codeMas14](https://doi.org/10.1088/0004-637X/791/2/121). The reference-sphere radius is 8.424 km. The quoted statistical error excludes the approximately 10% survey systematic floor (about 1.6848 km), shape/orientation effects and rotational sampling limitations.
...
The [zachia validation record](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/asteroids-size-calibration-validation.json) contains source, scale, atlas, installation and browser results for its recorded files and revision.
...
Published alternate pole solutions remain plausible: model 5902: λ=199°, β=24°, P=22.837 h. The selected first archived solution is not asserted to be uniquely correct.
...
DAMIT metadata report J2000 ecliptic pole λ=28°, β=29°, and rounded sidereal period 22.836 h. The original IAUspin file uses equatorial pole α=13°, δ=38°, dW/dt=378.343882°/day, W0=149.9° at JD 2451545.0. These are different frame conventions. The existing recipe uses the paired model-record ecliptic pole and period, with arbitrary display phase.
