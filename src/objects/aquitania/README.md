...
| --- | --- |
| Shape and spin | [DAMIT 1804](https://damit.cuni.cz/projects/damit/asteroid_models/view/1804) |
| Physical scale | [DAMIT model 1804 calibrated size, Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/asteroid_models/view/1804) ([record](source/reference/calibration.json)) |

[DAMIT model 1804](https://damit.cuni.cz/projects/damit/asteroid_models/view/1804), version 2017-06-19, is a nonconvex mesh fitted to light curves, adaptive-optics images and stellar occultations from [Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/references/view/169), *Volumes and bulk densities of forty asteroids from ADAM shape modeling*. The original 402 vertices and 800 triangular faces are the source input. Large concavities appear where the data constrain them; craters, surface texture and the current rotation phase are not resolved.

Adopted diameter: **100 ± 4 km**, meaning volume-equivalent diameter of the archived ADAM model, from [DAMIT model 1804 calibrated size, Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/asteroid_models/view/1804). The reference-sphere radius is 50 km. DAMIT marks model 1804 as size-calibrated (D = 100 km, σ = 4 km), the volume-equivalent diameter of this ADAM solution. Hanuš et al. (2017) Table 4 lists 97 ± 4 km for the publication fit; the archived release is kept as archived. The fit used 27 light curves, 7 adaptive-optics images and 1 occultation (Table 3).
...
The source's signed tetrahedral volume integral is 528279.06933 source units cubed, giving a volume-equivalent diameter of 100.297073354 source units. The preparation conversion is:

`metersPerUnit = D_km × 1000 / (2 × cbrt(3 × V_source / (4 × pi)))`

For this input, `metersPerUnit = 997.038065582273`. The raw mesh coordinates and connectivity are unchanged.
...
DAMIT reports the J2000 ecliptic pole λ = 123°, β = 46° and sidereal period 24.14011 h. Converted with obliquity 23.439291111°, the equatorial pole is α = 146.72°, δ = 63.09°. The archived [IAUspin file](https://damit.cuni.cz/projects/damit/stored_files/open/6113/IAUspin.txt) is kept as a frame and rate cross-check. Model longitude zero is an inversion convention, not an observed landmark.
