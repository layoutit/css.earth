...
The Europa photographic starfield uses the 6000 x 3000 public equirectangular
...
single-epoch Europa sky. The prepared Europa scene therefore uses the image
...
not add or bake a Sun. The complete ESO credit is exposed in Europa's source
resources.

## Astrometric registration (Europa)
