...
| SPHERE photograph | [32 deconvolved VLT/SPHERE/ZIMPOL frames, camera 1, 6 nights from 2019-07-28 to 2019-08-07](https://observations.lam.fr/astero/Data/15Eunomia/Deconv/) on the [ADAM reconstruction](https://observations.lam.fr/astero/3Dshape/15_Eunomia_adam.obj) |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `zimpol` | 32 | 20 | 9.50° | 5.82° | 7.51° | its other 32 frames | 1 of 32 | — | 9 of 32, 6.75° | — | ×1.05 | conflict |
...
The SPHERE photograph is photographed illumination from the survey's deconvolved frames, with matched relative frame levels. It is not albedo or colour. The frames see Eunomia from 8° to 10° south, so surface the survey did not see keeps the missing-imagery grid.
