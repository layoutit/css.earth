...
- **Systematics.** The MIRI fits drop the first 780 integrations, as Bell et al. (2024) did. They fit a linear trend, an exponential ramp, and the spatial position and width of the trace. The ramp's time constant is chosen from 0.005 to 0.16 days on the simplest candidate and then kept for all candidates. The NIRSpec curve is already detrended.
...
- **The MIRI light curves.** JWST program 1366 observed a full MIRI/LRS phase curve of WASP-43b on 1–2 December 2022. This project downloaded the 30 raw segments (44 GB) from MAST and reduced them with Eureka! 1.4 on the STScI pipeline (CRDS context jwst_1535.pmap). It used Bell et al. (2024)'s published control files, carried over to Eureka! 1.4's option names. The white light covers 5.0–10.5 µm, like theirs. The three slices cover 5.0–6.5, 6.5–8.5 and 8.5–10.5 µm. The fit breaks down beyond 10.5 µm. The exported curves and the median count spectrum are pinned in [source/science/jwst-1366-miri](source/science/jwst-1366-miri).

| Lens | Model | Dayside | Nightside | Hot spot | Published |
| --- | --- | --- | --- | --- | --- |
| NIRSpec refit | degree 3, 6 eigencurves | 1,580 K | 875 K | −2.3°, 7.1° E | map: −13.1°, 5.6° E |
| MIRI 5–10.5 µm | degree 2, 6 eigencurves | 1,527 K | 833 K | 0.8°, 5.3° E | 1,524 ± 35 K and 863 ± 23 K (Bell et al. 2024, 5–12 µm); 7.5 ± 0.5° E (Hammond et al. 2024) |
| MIRI 5–6.5 µm | degree 2, 4 eigencurves | 1,539 K | 831 K | 2.9° E | — |
| MIRI 6.5–8.5 µm | degree 2, 4 eigencurves | 1,493 K | 847 K | 8.4° E | — |
| MIRI 8.5–10.5 µm | degree 2, 4 eigencurves | 1,565 K | 914 K | 8.2° E | — |

Dayside and nightside are brightness temperatures of the flux each hemisphere shows, measured on 2026-09-17.
...
- [`lens-fits.test.mts`](../../../tests/objects/unit/wasp-43b/lens-fits.test.mts) runs the five fitted recipes as shipped:
  ...
  - The MIRI white-light map puts the dayside at 1,527 K, within Bell et al. (2024)'s 1,524 ± 35 K. The nightside is 833 K, 1.3σ below their 863 ± 23 K. Their values cover 5–12 µm, ours 5–10.5 µm.
  - Each slice's chosen model, dayside, nightside and hot spot longitude are held to the table above.
...
- **MIRI hot spot longitude.** The MIRI white-light map puts the hot spot 5.3° east. Hammond et al. (2024) fit the same observation with their own reduction and orbit and found 7.5 ± 0.5°. On Bell et al.'s deposited light curve, this project's fit gives 5.0°. The difference is not resolved.
