...
| Offset | 6.2° E | 7.5 ± 0.5° E (Hammond et al. 2024) |
...
- **The MIRI offset is 1.3° west of Hammond et al.'s, because the light curve admits two systematics solutions and they took the other one.** Hammond et al. (2024) report 7.5 ± 0.5° for the same observation; this map gives 6.2° ([`hammond-offset.test.mts`](../../../tests/objects/unit/wasp-43b/hammond-offset.test.mts)).
