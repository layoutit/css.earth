...
fitted offset; the SEDR errors removed here were 77–156 pixels and the accepted fits have an
RMS of 0.38–1.35 pixels. Each frame is then registered against the Schenk 2020 mosaic rendered
...
dropped rather than fringed. Applied registrations correlate at 0.21–0.52. 17 frames in
6 sets were placed: set-19860123-2347 (7.4 km/px), set-19860123-2004 (8.9 km/px), set-19860123-1831 (9.6 km/px), set-19860123-1716 (10.1 km/px), set-19860123-1541 (10.8 km/px), set-19860122-0849 (24.4 km/px). 13 frames were not: 7 the limb fit rejected it; 6 no frame of this set registered against the mosaic.
...
of both, and ground the finest set views too steeply goes to the next set (`withheld: next-observation`). The other sets are scaled band by band onto the set-19860123-2347 set by weighted least squares over the median ratios of all overlapping pairs on a 0.25° grid (`bandLevels`; gains set-19860123-1541: 0.777, 0.742, 0.744; set-19860123-1716: 0.826, 0.795, 0.812; set-19860123-1831: 0.878, 0.851, 0.854; set-19860122-0849: 1.070, 1.023, 1.078).
The archive's filter calibration leaves violet darker than both green and ultraviolet on every one of
the five moons (measured here, Titania: violet/green 0.830, ultraviolet/green 0.912), which is also what the
...
published whole-disc spectra normalised at green; read from their Fig. 2 at ±0.02, Titania has
ultraviolet/green 0.92 and violet/green 0.96. The recipe names those ratios (`bandRatios`) and the
composer scales the violet and ultraviolet bands by one gain each (1.157, 1.008) so the
