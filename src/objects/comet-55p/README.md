...
Tempel–Tuttle supplies the dust that makes the Leonid meteor shower. Earth encounters these particles as it crosses the comet’s trail each November.

One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 1.8 km (Lamy, Toth, Fernández and Weaver (2004), Comets II, 223). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Lamy, Toth, Fernández and Weaver (2004), Comets II, 223](https://doi.org/10.2307/j.ctv1v7zdq5.22), tessellated as a smooth ellipsoid. |
