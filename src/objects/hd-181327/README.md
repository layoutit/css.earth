...
- **The debris ring** is the attached volume [hd-181327-disc](../hd-181327-disc/README.md): the JWST/NIRCam F182M coronagraph image of programme 2780 (Gáspár et al. 2026, [arXiv:2608.27437](https://arxiv.org/abs/2608.27437)), in the paper's own colours and scale, placed in depth on the ring fitted to it.
