...
| --- | --- |
| Shape and spin | [DAMIT 5480](https://damit.cuni.cz/projects/damit/asteroid_models/view/5480) |
| Physical scale | [Calibration and uncertainty](source/reference/calibration.json) |

[DAMIT model 5480](https://damit.cuni.cz/projects/damit/asteroid_models/view/5480), version 2019-10-23, from Ďurech et al. (2020), is a convex lightcurve inversion mesh. The original 574 vertices and 1144 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness.

Concavities, craters, surface texture and exact current rotation phase are not resolved.

Adopted diameter: **40.828 ± 0.247 km**, meaning **effective body diameter**, from [Masiero et al. (2014), PDS NEOWISE Diameters and Albedos V2.0, reference codeMas14](https://doi.org/10.1088/0004-637X/791/2/121). The reference-sphere radius is 20.414 km. The quoted statistical error excludes the approximately 10% survey systematic floor (about 4.0828 km), shape/orientation effects and rotational sampling limitations.
...
The [selinur validation record](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/asteroids-size-calibration-validation.json) contains source, scale, atlas, installation and browser results for its recorded files and revision.
...
DAMIT metadata report J2000 ecliptic pole λ=136°, β=-56°, and rounded sidereal period 8.0117 h. The original IAUspin file uses equatorial pole α=121°, δ=-37°, dW/dt=1078.417715°/day, W0=239.3° at JD 2451545.0. These are different frame conventions. The existing recipe uses the paired model-record ecliptic pole and period, with arbitrary display phase.
