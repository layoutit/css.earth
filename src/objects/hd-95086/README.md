...
**Placement.** Gaia DR3 source 5231963962676292224 (Gaia Collaboration 2023): position at J2016.0, proper motion and parallax ([source record](../../sources/gaia-dr3-hd-95086.json)).

**Radius, temperature and mass.** 7,750 ± 250 K and 1.6 ± 0.1 solar masses as Desgrange et al. ([2022](https://arxiv.org/abs/2206.00425), A&A 664, A139) tabulate them (Table 1). No paper used here gives a radius, so it is Gaia DR3's FLAME value, 1.52 solar radii: a model value, not a measured disc.

**Radial velocity.** Gaia DR3's 18.04 ± 0.16 km/s.

**Colour lens.** The colour of Gaia DR3's externally calibrated BP/RP sampled spectrum of the star, weighted by the CIE 1931 2° observer from 380 to 780 nm and converted to sRGB with the D65 white ([stellar-photometric-color.mts](../../../tools/objects/observation/stellar/stellar-photometric-color.mts)). Its limb is darkened by the quadratic law Claret & Bloemen (2011), A&A 529, A75 computes from ATLAS model atmospheres for the Johnson V band at 7,750 K (the record) and log g 4.28 (from the record's mass and radius (packages/astronomy/data/bodies/hd-95086.json)): a model, since no fit of this star's limb exists.
...
- The limb darkening is a model: the quadratic law Claret & Bloemen (2011), A&A 529, A75 computes from ATLAS model atmospheres for the Johnson V band at 7,750 K (the record) and log g 4.28 (from the record's mass and radius (packages/astronomy/data/bodies/hd-95086.json)).
