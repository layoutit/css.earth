...
One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 1.62 km (Snodgrass, Lowry and Fitzsimmons (2006), MNRAS 373, 1590). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Snodgrass, Lowry and Fitzsimmons (2006), MNRAS 373, 1590](https://doi.org/10.1111/j.1365-2966.2006.11121.x), tessellated as a smooth ellipsoid. |
