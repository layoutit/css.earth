...
One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 3.4 km (Eisner et al. (2019), AJ 157, 186). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Eisner et al. (2019), AJ 157, 186](https://doi.org/10.3847/1538-3881/ab0f42), tessellated as a smooth ellipsoid. |
