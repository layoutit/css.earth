...
**Colour lens.** The colour of Gaia DR3's externally calibrated BP/RP sampled spectrum of the star, weighted by the CIE 1931 2° observer from 380 to 780 nm and converted to sRGB with the D65 white ([stellar-photometric-color.mts](../../../tools/objects/observation/stellar/stellar-photometric-color.mts)): **#c2d4ff**, the hue Fomalhaut's ground-based spectrum gives. The disc is darkened toward its edge by the quadratic V-band law Claret & Bloemen (2011) compute from ATLAS model atmospheres, read at 8090 K (Zwintz et al. 2019) and log g 4.30 (from the mass and radius): a model, not a measurement of this star.
