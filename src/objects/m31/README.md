...
- The generated [runtime inventory](runtime-assets.json) contains 92 layer images, the bank, presentation, provenance and one dataset preview (96 assets). Its staging copy is identical; the preview stays at its existing public location.
