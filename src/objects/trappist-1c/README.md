...
TRAPPIST-1c is the second planet out planets of [TRAPPIST-1](../trappist-1/README.md), an ultracool dwarf 12.47 parsecs away. Every number in this
...
- [`source.test.mts`](../../../tests/objects/unit/trappist-1c/source.test.mts) checks the pins and that the package's radius, mass and
