...
| --- | --- |
| Shape and spin | [DAMIT 4383](https://damit.cuni.cz/projects/damit/asteroid_models/view/4383) |
...
The unmodified source has 1020 vertices and 2036 triangles. Its signed tetrahedral volume is 0.99999990165608477 source units³; an independent triangle-centroid divergence sum gives 0.99999990165608477. The existing recipe applies one uniform scale of 97.219237933706893 km per source unit so its volume-equivalent diameter is 120.62 km.

No unit-volume assumption is made. Radius above a 60.31 km sphere is a shape-derived scalar, not gravitational height or measured geology.

The original +Z spin axis and +X reference meridian are retained. The source pole is ecliptic J2000 (291°, 12°), with sidereal period 21.0401 h. Conversion to equatorial J2000 uses obliquity 23.439291111°. Position uses JPL Horizons heliocentric ICRF elements at 2026-09-03 TT (TDB approximated as TT, under 2 ms).
...
The established source-meshoptimizer path starts from the source connectivity, reduces to at most 800 faces, and emits native PolyCSS `u` triangles with 128 px raster cells. The error allowance is 1206.2 m; sampled source-fit error is qualified separately from source accuracy.
