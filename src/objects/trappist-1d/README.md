...
**Orbit.** 4.049219 days at 0.02227 au, 1.115 times the starlight Earth receives (Agol et al. (2021, PSJ 2, 1), Tables 2, 5 and 6). The
...
- [`source.test.mts`](../../../tests/objects/unit/trappist-1d/source.test.mts) checks the pins and that the package's radius, mass and
