...
One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 1.82 km (Pittichová et al. (2008), AJ 136, 1127). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Pittichová et al. (2008), AJ 136, 1127](https://doi.org/10.1088/0004-6256/136/3/1127), tessellated as a smooth ellipsoid. |
