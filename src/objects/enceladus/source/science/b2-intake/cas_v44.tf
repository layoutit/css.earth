...
RECORD_TYPE                  = STREAM
RECORD_BYTES                 = "N/A"
^SPICE_KERNEL                = "cas_v44.tf"
MISSION_NAME                 = "CASSINI-HUYGENS"
SPACECRAFT_NAME              = "CASSINI ORBITER"
DATA_SET_ID                  = "CO-S/J/E/V-SPICE-6-V1.0"
KERNEL_TYPE_ID               = FK
PRODUCT_ID                   = "cas_v44.tf"
PRODUCT_CREATION_TIME        = 2026-06-11T12:07:02
...
OBJECT                       = SPICE_KERNEL
  ...
  KERNEL_TYPE                = FRAMES
  DESCRIPTION                = "SPICE Frames Kernel file containing the
Cassini spacecraft, science instrument, and communication antennae frame
definitions. "
...
----------------------------------------------------------
   ...
   Cassini Frame Kernel Version:
           ...
           TEXT_KERNEL_ID += 'CASSINI_FRAMES V4.4.0 28-JUL-2025 FK'

           \begintext

   Version 4.4 -- July 28, 2025 -- Boris Semenov

            --   Added DSK surface name/ID mappings for V2 Enceladus
                 DSKs produced by the JPL SSD group in 2025 (see [56]).
...
========================================================================
   ...
   Dynamics (SSD) group (see [56]):
      ...
      CAS_SSD_SPC_0128ICQ_V2          20121         602
      CAS_SSD_SPC_0256ICQ_V2          20122         602
      CAS_SSD_SPC_0512ICQ_V2          20123         602
      CAS_SSD_SPC_1024ICQ_V2          20124         602 
      CAS_SSD_SPC_SOUTH100M_V2        20125         602 
      CAS_SSD_SPC_SOUTH050M_V2        20126         602
      CAS_SSD_SPC_SOUTH025M_V2        20127         602
      CAS_SSD_SPC_EQ035M_V2           20128         602
           ...
           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_0128ICQ_V2'
           NAIF_SURFACE_CODE        += 20121
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_0256ICQ_V2'
           NAIF_SURFACE_CODE        += 20122
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_0512ICQ_V2'
           NAIF_SURFACE_CODE        += 20123
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_1024ICQ_V2'
           NAIF_SURFACE_CODE        += 20124
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_SOUTH100M_V2'
           NAIF_SURFACE_CODE        += 20125
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_SOUTH050M_V2'
           NAIF_SURFACE_CODE        += 20126
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_SOUTH025M_V2'
           NAIF_SURFACE_CODE        += 20127
           NAIF_SURFACE_BODY        += 602

           NAIF_SURFACE_NAME        += 'CAS_SSD_SPC_EQ035M_V2'
           NAIF_SURFACE_CODE        += 20128
           NAIF_SURFACE_BODY        += 602
