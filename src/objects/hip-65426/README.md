...
- The limb darkening is a model: the quadratic law Claret & Bloemen (2011), A&A 529, A75 computes from ATLAS model atmospheres for the Johnson V band at 8,840 K (the record) and log g 4.23 (from the record's mass and radius (packages/astronomy/data/bodies/hip-65426.json)).
