...
Its **derived display semi-axes** are **7.684319 × 7.115110 × 7.115110 km**. Equal-volume scaling to the 7.3 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **10.691 ± 0.001 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 621, Saturn XXI, **S/2000 S4**, resolves to **SAT456**. Mean elements establish identity and context.
