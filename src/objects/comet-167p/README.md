...
CINEOS follows a distant orbit that stays beyond Saturn at its closest approach to the Sun. Its nucleus is represented here by a sphere at the published NEOWISE effective radius.

One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 33.1 km (Bauer et al. (2013), ApJ 773, 22). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Bauer et al. (2013), ApJ 773, 22](https://doi.org/10.1088/0004-637X/773/1/22), tessellated as a smooth ellipsoid. |
