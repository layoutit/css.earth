...
Lysithea is an irregular moon of Jupiter.

## Identity

Lysithea is Jupiter X. JPL Horizons carries it as body 510.

## Sources

Pinned inputs are listed in the [source manifest](source/manifest.json).

JPL Horizons lists a radius of 12 km on Lysithea's object data page (revised 2025-May-12). Horizons gives no shape, albedo map or rotation state for it.
