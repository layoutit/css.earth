...
Shape uses the shared no-imagery grid. It is not photographed color, reflectance, regolith or inferred composition. Elevation samples the original mesh radius minus a 104 km reference sphere, with a -30 to 20 km legend. This includes global shape, not height above a gravitational equipotential.
...
- [Released SPHERE images](https://observations.lam.fr/astero/Data/24Themis/): individual, illuminated, resolved telescope images. Excluded as a globe texture in this PR: they are not a registered global reflectance mosaic. They remain the observational constraints behind the selected reconstruction.
