...
HD 136352 d transits HD 136352 every 107 days and is 2.6 Earth radii across. Orbit and size follow Delrez et al. 2021's fit, the archive's default. This account was drafted from Delrez et al. 2021's values; the sections below are the data's own.
