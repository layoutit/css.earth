...
- **The colour is uncertain in hue.** The blue and green are faint enough that the noise moves the colour from red-pink to lilac.
- **No surface map.** No map of A is deposited ([ledger](investigations.json)).
