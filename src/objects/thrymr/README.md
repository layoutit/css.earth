...
- The published period is tentative; it does not establish a secure current rotation prediction.
...
Its **derived display semi-axes** are **4.314931 × 3.566059 × 3.566059 km**. Equal-volume scaling to the 3.8 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **38.79 ± 0.25 h · tentative** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 630, Saturn XXX, **S/2000 S7**, resolves to **SAT456**. Mean elements establish identity and context.
