...
TRAPPIST-1f is the fifth planet out planets of [TRAPPIST-1](../trappist-1/README.md), an ultracool dwarf 12.47 parsecs away. Every number in this
...
**Orbit.** 9.207540 days at 0.03849 au, 0.373 times the starlight Earth receives (Agol et al. (2021, PSJ 2, 1), Tables 2, 5 and 6). The
...
- [`source.test.mts`](../../../tests/objects/unit/trappist-1f/source.test.mts) checks the pins and that the package's radius, mass and
