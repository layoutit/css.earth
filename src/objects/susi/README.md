...
| --- | --- |
| Shape and spin | [DAMIT 5856](https://damit.cuni.cz/projects/damit/asteroid_models/view/5856) |
| Physical scale | [Calibration and uncertainty](source/reference/calibration.json) |

[DAMIT model 5856](https://damit.cuni.cz/projects/damit/asteroid_models/view/5856), version 2019-10-23, from Ďurech et al. (2020), is a convex lightcurve inversion mesh. The original 562 vertices and 1120 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness.

Concavities, craters, surface texture and exact current rotation phase are not resolved.

Adopted diameter: **21.82 ± 1.4 km**, meaning **mean radiometric diameter from IRAS flux-based albedo and H**, from [IRAS-A-FPA-3-RDR-IMPS-V6.0](https://doi.org/10.26033/pf3k-m168). The reference-sphere radius is 10.91 km. Quoted 1σ uncertainty derives solely from IRAS flux precision (original label DIAM_UNC).
