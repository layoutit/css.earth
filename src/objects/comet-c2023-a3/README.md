...
One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 5.9 km (Liu, Hui and Liu (2025), A&A 698, A95). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Liu, Hui and Liu (2025), A&A 698, A95](https://doi.org/10.1051/0004-6361/202554632), tessellated as a smooth ellipsoid. |
