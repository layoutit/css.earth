...
Distance is uncertain. We adopt 650 pc as explicitly used in [Sánchez Contreras et al. (2024)](https://arxiv.org/html/2411.03825v1). [Corradi et al. (2011)](https://arxiv.org/abs/1102.5634) infer 1300 ± 200 pc from expansion; that choice would double this model's size. This photograph's footprint is about 0.183 pc wide at 650 pc; the larger total-nebula extent in the paper is not substituted for its smaller image field.
