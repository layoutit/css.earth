...
Convex light-curve reconstruction with approximate thermal size: 150.24 km effective diameter (catalog ±1.66 km; additional shape and thermal-model uncertainty). Thermal size is used as a volume-scale approximation. Neutral gray marks unavailable imagery; rotational phase is illustrative.
