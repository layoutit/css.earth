...
The release supplies no registered surface imagery; neutral gray marks that gap. Alternative archive solutions: model 330, pole ['40', '-9'], [Model 330](https://damit.cuni.cz/projects/damit/asteroid_models/view/330)
