...
The [huberta results](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **315.91 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; neutral gray marks that gap. Alternative archive solutions: model 579, pole ['23', '-28'], [Model 579](https://damit.cuni.cz/projects/damit/asteroid_models/view/579)
...
The established source-meshoptimizer path retains source connectivity, reduces to at most 800 faces, and emits native PolyCSS `u` triangles with 128 px raster cells. The error allowance is 952 m; sampled source-fit error is qualified separately from source accuracy.
