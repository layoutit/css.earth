...
One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 4.6 km (Campins and Fernández (2002), Earth, Moon and Planets 89, 117). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Campins and Fernández (2002), Earth, Moon and Planets 89, 117](https://doi.org/10.1023/a:1021590203207), tessellated as a smooth ellipsoid. |
