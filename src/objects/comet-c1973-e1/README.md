...
One **Shape approximation** dataset shows an ellipsoid at the published effective nucleus radius of 6.25 km (Rieke and Lee (1974), Nature 248, 737). The whole surface carries the missing-imagery grid. Shadows defaults off.

## Sources

| Source | What it supplies |
| --- | --- |
| [Shape parameters](source/shape/model.json) | Published effective nucleus radius and shape statement from [Rieke and Lee (1974), Nature 248, 737](https://doi.org/10.1038/248737a0), tessellated as a smooth ellipsoid. |
