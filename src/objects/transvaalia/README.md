...
| --- | --- |
| Shape and spin | [DAMIT 3722](https://damit.cuni.cz/projects/damit/asteroid_models/view/3722) |
| Physical scale | [Calibration and uncertainty](source/reference/calibration.json) |

[DAMIT model 3722](https://damit.cuni.cz/projects/damit/asteroid_models/view/3722), version 2019-05-07, from Ďurech et al. (2019), is a convex lightcurve inversion mesh. The original 574 vertices and 1144 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness.

Concavities, craters, surface texture and exact current rotation phase are not resolved.

Adopted diameter: **25.458 ± 0.591 km**, meaning **effective body diameter**, from [Masiero et al. (2012), PDS NEOWISE Diameters and Albedos V2.0, reference codeMas12](https://doi.org/10.1088/2041-8205/759/1/L8). The reference-sphere radius is 12.729 km. The quoted statistical error excludes the approximately 20% survey systematic floor (about 5.0916 km), shape/orientation effects and rotational sampling limitations.
...
The [transvaalia validation record](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/asteroids-size-calibration-validation.json) contains source, scale, atlas, installation and browser results for its recorded files and revision.
...
Published alternate pole solutions remain plausible: model 3723: λ=312°, β=30°, P=11.8258 h. The selected first archived solution is not asserted to be uniquely correct.
...
DAMIT metadata report J2000 ecliptic pole λ=125°, β=62°, and rounded sidereal period 11.82586 h. The original IAUspin file uses equatorial pole α=180°, δ=74°, dW/dt=730.602256°/day, W0=20.2° at JD 2451545.0. These are different frame conventions. The existing recipe uses the paired model-record ecliptic pole and period, with arbitrary display phase.
