...
The Pluto photographic starfield uses the 6000 x 3000 public equirectangular
...
single-epoch Pluto sky. The prepared Pluto scene therefore uses the image
...
not add or bake a Sun. The complete ESO credit is exposed in Pluto's source
resources.

The same pinned panorama is shared by other object packages. It is a contextual
sky background, not a photograph taken from Pluto.
