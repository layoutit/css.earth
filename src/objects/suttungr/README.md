...
Its **derived display semi-axes** are **3.908313 × 3.312130 × 3.312130 km**. Equal-volume scaling to the 3.5 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **7.67 ± 0.02 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 623, Saturn XXIII, **S/2000 S12**, resolves to **SAT456**. Mean elements establish identity and context.
