...
[2026-09-22 exoplanet radius and route check](../../../site/test/evidence/exoplanets/2026-09-22/README.md): the 7,462.4 km source radius agrees with the scene and world frame. The pinned prepared package restored from the runtime inventory and passed its runtime contract; Chrome opened this route, showed the 1.17 Earth-radii fact and reported no console errors after the view settled. No assets were rebaked for this body.

## Known problems

**Is it a planet?** Disputed. Torres et al. (2015) validated it. Burke et al. (2019, arXiv:1901.00506) find it "no longer meets the 1% criterion for statistical validation" and revise its planet probability to 96%; Robnik & Seljak (2025, arXiv:2509.07409) give it a 20% false-alarm probability and do not count it as validated. The package draws it as the validation paper describes it.
