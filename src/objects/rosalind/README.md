...
- The finest candidate vg-iss-2-u-c2696148 lists 45.93296 km/native pixel, but has no recorded Rosalind surface intersection or located pixel center. Its actual GEOMED raster and label were inspected.

## Known problems

- The third axis repeats the minor axis by the published prolate assumption. This is an analytic approximation, not a detailed measured terrain mesh. The reported projected radius is 36 ± 6 km and minor/major ratio 1 ± 0.2; these are not separate-axis error bars.
...
- The shared display then advances the secular spin rate -644.631126°/day and freezes the small periodic correction. This is not a complete long-term rotation ephemeris or landmark registration.
