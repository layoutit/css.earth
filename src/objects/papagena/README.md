...
| --- | --- |
| Shape and spin | [DAMIT 1798](https://damit.cuni.cz/projects/damit/asteroid_models/view/1798) |
| Physical scale | [DAMIT model 1798 calibrated size, Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/asteroid_models/view/1798) ([record](source/reference/calibration.json)) |

[DAMIT model 1798](https://damit.cuni.cz/projects/damit/asteroid_models/view/1798), version 2017-06-19, is a nonconvex mesh fitted to light curves, adaptive-optics images and stellar occultations from [Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/references/view/169), *Volumes and bulk densities of forty asteroids from ADAM shape modeling*. The original 402 vertices and 800 triangular faces are the source input. Large concavities appear where the data constrain them; craters, surface texture and the current rotation phase are not resolved.

Adopted diameter: **133 ± 4 km**, meaning volume-equivalent diameter of the archived ADAM model, from [DAMIT model 1798 calibrated size, Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/asteroid_models/view/1798). The reference-sphere radius is 66.5 km. DAMIT marks model 1798 as size-calibrated (D = 133 km, σ = 4 km), the volume-equivalent diameter of this ADAM solution. Hanuš et al. (2017) Table 4 lists 132 ± 4 km for the publication fit; the archived release is kept as archived. The fit used 13 light curves, 1 adaptive-optics image and 2 occultations (Table 3).
...
The source's signed tetrahedral volume integral is 1221568.1453 source units cubed, giving a volume-equivalent diameter of 132.629365596 source units. The preparation conversion is:

`metersPerUnit = D_km × 1000 / (2 × cbrt(3 × V_source / (4 × pi)))`

For this input, `metersPerUnit = 1002.79451237619`. The raw mesh coordinates and connectivity are unchanged.
...
DAMIT reports the J2000 ecliptic pole λ = 224°, β = 58° and sidereal period 7.11539 h. Converted with obliquity 23.439291111°, the equatorial pole is α = 240.55°, δ = 39.17°. The archived [IAUspin file](https://damit.cuni.cz/projects/damit/stored_files/open/1054/IAUspin.txt) is kept as a frame and rate cross-check. Model longitude zero is an inversion convention, not an observed landmark.
