...
Physical-size credit: [DAMIT model 1798 calibrated size, Hanuš et al. (2017), A&A 601, A114](https://damit.cuni.cz/projects/damit/asteroid_models/view/1798). JPL Small-Body Database and Horizons records are credited to NASA/JPL. Article PDFs and reference documents retain their own publication notices; the DAMIT CC BY license does not override those notices.
