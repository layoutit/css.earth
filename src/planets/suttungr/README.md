...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. Two/three extrema; ellipsoid demonstrates only the minimum elongation. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire suttungr
node tools/objects/dist/prepare-authored.js suttungr --write
```
