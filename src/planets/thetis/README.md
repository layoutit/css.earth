...
The [thetis results](../../../docs/evidence/main-belt-asteroids/summary.json) record a maximum sampled source-to-display distance of **261.84 m**. This is a sampled comparison, not an exhaustive error bound.
