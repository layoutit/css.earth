...
independent proof scripts are in the task's ignored `output/b7-vims/` directory.
Copy the relevant evidence into final review artifacts when integration is
qualified; these source checks alone do not establish browser readiness.
