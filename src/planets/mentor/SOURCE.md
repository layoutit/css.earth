# (3451) Mentor: source and interpretation

Checked 2026-09-09. L5 Jupiter Trojan. Selected DAMIT model **4281**, version **2019-05-07**. DAMIT, Astronomical Institute of Charles University; Ďurech et al. (2019); model 4281, version 2019-05-07.

## Shape, scale and orientation

Convex light-curve reconstruction with approximate thermal size: 126.288 km effective diameter (fit ±1.642 km; additional shape and thermal-model uncertainty). An alternative pole solution remains in the archive. Thermal size is used as a volume-scale approximation; grid marks unavailable imagery.
...
The unmodified source has 572 vertices and 1140 triangles. Its signed tetrahedral volume is 1.0000001243334133 source units³; independent triangle-centroid divergence gives 1.0000001243334136. The existing recipe applies a uniform scale of 101.78761572588223 km per source unit. No unit-volume assumption is made. Radial Elevation is source radius minus the declared 63.144 km reference sphere, in false color; it is neither gravitational height nor independent topography.

Original +Z spin axis and +X reference meridian are retained. The selected ecliptic J2000 pole is (237°, 57°), with sidereal period 7.69659 h. Conversion to equatorial J2000 uses obliquity 23.439291111°. Absolute phase is arbitrary and accelerated display spin is illustrative. Position uses JPL Horizons heliocentric ICRF elements at 2026-09-03 TT (TDB approximated as TT, under 2 ms).

## Source survey

- [Selected model](https://damit.cuni.cz/projects/damit/asteroid_models/view/4281) and [original mesh](https://damit.cuni.cz/projects/damit/stored_files/open/13357/shape.txt) — included without modifying original coordinates/connectivity. Convex light-curve inversion; concavities and fine relief are unresolved.
