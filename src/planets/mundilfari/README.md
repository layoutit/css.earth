...
<a id="mundilfari-source-survey"></a>
...
Its **derived display semi-axes** are **4.442479 × 3.106629 × 3.106629 km**. Equal-volume scaling to the 3.5 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **6.74 ± 0.08 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 625, Saturn XXV, **S/2000 S9**, resolves to **SAT456**. Mean elements establish identity and context.
