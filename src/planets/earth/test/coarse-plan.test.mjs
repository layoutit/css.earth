...
import { prepareCoarsePageGeometry, coarsePageFootprint } from '../tools/city/coarse-page.mjs';
import { coarseSourceAvailability, coarseSourceTileKeys, coarseSourceAddress, planGlobalCoarse } from '../tools/city/coarse-plan.mjs';
