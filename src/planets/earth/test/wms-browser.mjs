...
import { pageCoordinates, prepareLocationPoint, prepareLocationCamera } from "../tools/city/prepare-location.mjs";
...
try{
  ...
  for(const dpr of [1,2]){
    ...
    try{
      ...
      await context.route("**/runtime/preparedCityPages.mjs",route=>route.fulfill({
        contentType:"text/javascript",body:`export const PREPARED_EARTH_CITY_PAGES=Object.freeze(${JSON.stringify(plan)});`,
      }));
