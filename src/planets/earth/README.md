...
| Night lights | NASA Black Marble VJ146A4 Collection 2, 2025 annual snow-free radiance, from Jurij Stare's public raw-data mosaic. Numeric samples are area-averaged and shown with a logarithmic color scale. | Coverage is 75° N–65° S. The mirror lacks quality bands. This is neither live lighting nor ground-level sky brightness. |
