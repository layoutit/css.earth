...
export function prepareWmtsBlocks(pages, dataset, { tileSide = 8 } = {}) {
  ...
  for (const [key, members] of [...groups].sort(([a], [b]) => a.localeCompare(b))) {
    ...
    const ref = { encoding: PREPARED_BLOCK_ENCODING, url: `/scenes/earth/wmts-index-${sha256.slice(0, 16)}.bin.gz`,
