...
export async function publishPreparedCityAssets({ source, cors, assetUrls, staging, root,
  verifyOnly = false, dryRun = false, batchSize = 256, concurrency = 2 }) {
...
async function verifyPublishedAssets(assets, cors) {
...
async function publishedAssetMatches(asset, origin) {
