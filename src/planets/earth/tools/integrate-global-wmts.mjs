...
import { preserveCoarseBacking } from "./city/coarse-integration.mjs";
...
const plan=preserveCoarseBacking(existing,{schema:existing.schema,dataset:manifest.dataset,qualification:manifest.qualification,credit:existing.credit,sourcePage:existing.sourcePage,
