...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. Period tentative; an approximately 19-hour alternative remains possible. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire greip
node tools/objects/dist/prepare-authored.js greip --write
```
