...
Its **derived display semi-axes** are **2.568320 × 2.176543 × 2.176543 km**. Equal-volume scaling to the 2.3 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **12.75 ± 0.35 h · tentative** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 651, Saturn LI, **S/2006 S4**, resolves to **SAT456**. Mean elements establish identity and context.
