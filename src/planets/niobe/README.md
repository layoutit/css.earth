...
The [niobe results](../../../docs/evidence/main-belt-asteroids/summary.json) record a maximum sampled source-to-display distance of **231.13 m**. This is a sampled comparison, not an exhaustive error bound.
