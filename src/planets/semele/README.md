...
The [semele results](../../../docs/evidence/main-belt-asteroids/summary.json) record a maximum sampled source-to-display distance of **182.56 m**. This is a sampled comparison, not an exhaustive error bound.
