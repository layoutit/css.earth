# (999) Zachia: sources and interpretation

## Selected shape

[DAMIT model 5901](https://damit.cuni.cz/projects/damit/asteroid_models/view/5901), version 2019-10-23, from Ďurech et al. (2020), is a convex lightcurve inversion mesh. The original 552 vertices and 1100 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness. Concavities, craters, surface texture and exact current rotation phase are not resolved.
