...
export const MUTATIONS = Object.freeze([
  ...
  },
  {
    ...
    file: "src/planets/mercury/runtime/client.mjs",
    find: "          lighting.baseLightAzimuthDegrees,\n      );",
    replace: "          lighting.baseLightAzimuthDegrees + 180, /* MUTATION light-roll-180 */\n      );",
    prepare: [],
    served: { url: "/src/planets/mercury/runtime/client.mjs", marker: "MUTATION light-roll-180" },
    expect: /lit-direction-matches-oracle|terminator|lit-side-faces/u,
  },
  {
    id: "skybox-yaw-flip-drag",
    description: "sky yaw inverted on the drag path (presentation-sky convention)",
    file: "src/platform/cubic-sky-runtime.mjs",
    find: "        ? sceneDelta.multiply(skyboxMatrix)",
    replace: "        ? new DOMMatrix().rotateAxisAngle(1, 0, 0, renderedPitchDelta)" +
      ".rotateAxisAngle(0, 1, 0, -yawDelta).multiply(skyboxMatrix) /* MUTATION skybox-yaw-flip-drag */",
    prepare: [],
    served: { url: "/src/platform/cubic-sky-runtime.mjs", marker: "MUTATION skybox-yaw-flip-drag" },
    expect: /drag-(right|left)-sky-moves-with-sun/u,
  },
  {
    id: "skybox-yaw-flip-reset",
    description: "sky yaw inverted on the reset path",
    file: "src/platform/cubic-sky-runtime.mjs",
    find: "      ? sceneMatrix.multiply(skyRegistration)",
    replace: "      ? createSceneMatrix(nextPitch, -nextYaw, cameraPlan).multiply(skyRegistration) /* MUTATION skybox-yaw-flip-reset */",
    prepare: [],
    served: { url: "/src/platform/cubic-sky-runtime.mjs", marker: "MUTATION skybox-yaw-flip-reset" },
    expect: /sky-.*band-angle|sky-anchor|sky-bulge/u,
  },
  {
    id: "sky-pitch-response-legacy",
    description: "sky pitches with the legacy -1.7 response instead of riding the scene",
    file: "src/platform/cubic-sky-runtime.mjs",
    find: "        ? sceneDelta.multiply(skyboxMatrix)",
    replace: "        ? new DOMMatrix().rotateAxisAngle(1, 0, 0, renderedPitchDelta * -1.7)" +
      ".rotateAxisAngle(0, 1, 0, yawDelta).multiply(skyboxMatrix) /* MUTATION sky-pitch-response-legacy */",
    prepare: [],
    served: { url: "/src/platform/cubic-sky-runtime.mjs", marker: "MUTATION sky-pitch-response-legacy" },
    expect: /drag-(down|up)-sky-moves-with-sun/u,
  },
  {
    id: "mirror-panorama",
