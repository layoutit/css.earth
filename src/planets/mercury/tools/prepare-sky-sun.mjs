...
// Mercury's Sun direction is the observed one, not a presentation constant:
...
// fact stay standard.
const bodyFixedDirection = requireBodyFixedSunDirection("mercury");
const sceneDirection = MERCURY_PRESENTATION_FRAME.sunDirection;
