...
The [coelestina results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **96.43 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 1219, pole ['42', '14'], [Model 1219](https://damit.cuni.cz/projects/damit/asteroid_models/view/1219)
