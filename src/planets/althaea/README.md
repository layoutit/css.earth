...
The [althaea results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **171.89 m**. This is a sampled comparison, not an exhaustive error bound.
