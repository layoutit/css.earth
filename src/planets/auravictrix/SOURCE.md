# (700) Auravictrix: sources and interpretation

## Selected shape

[DAMIT model 1654](https://damit.cuni.cz/projects/damit/asteroid_models/view/1654), version 2016-01-12, from Ďurech et al. (2016), is a convex lightcurve inversion mesh. The original 1022 vertices and 2040 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness. Concavities, craters, surface texture and exact current rotation phase are not resolved.
