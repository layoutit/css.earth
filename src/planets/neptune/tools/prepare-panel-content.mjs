...
const panel = deepFreeze({
  ...
  planetId: "neptune",
  introduction: "Neptune is the eighth and most distant planet from the Sun: a cold blue ice giant with a turbulent atmosphere.",
  facts: [
    { id: "distance-from-sun", label: "Distance from Sun", value: `${capture(size, /\((4\.5 billion) kilometers\)/u)} km` },
    { id: "diameter", label: "Diameter", value: `${capture(size, /\((49,528) kilometers\)/u)} km` },
    { id: "orbital-period", label: "Orbital period", value: `${capture(orbit, /about (165) Earth years/u)} Earth years` },
    { id: "rotation-period", label: "Rotation period", value: `${capture(orbit, /takes about (16) hours/u)} hours` },
    { id: "axial-tilt", label: "Axial tilt", value: `${capture(orbit, /tilted (28) degrees/u)}°` },
    { id: "moon-count", label: "Moons", value: capture(moons, /Neptune has (16) known moons/u) },
    { id: "ring-system", label: "Rings", value: "Present" },
  ],
  moreFacts: [
    { id: "wind-speed", label: "Wind", value: `${capture(atmosphere, /\((2,000) kilometers per hour\)/u)} km/h` },
  ],
