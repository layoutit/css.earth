...
- The formal pinned Python environment reproduced the exact ZIP hash (see [docs/moons/b2-preparation/enceladus-dsk-reproduction.json](../../../docs/moons/b2-preparation/enceladus-dsk-reproduction.json)).
