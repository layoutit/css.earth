...
import {
  GANYMEDE_CAMERA_POSE,
  GANYMEDE_PRESENTATION_FRAME,
...
// Ganymede's Sun direction is the observed one, not a presentation constant:
...
// fact stay standard.
const bodyFixedDirection = requireBodyFixedSunDirection("ganymede");
const sceneDirection = GANYMEDE_PRESENTATION_FRAME.sunDirection;
...
await preparePlanetDirectionalSun({
  ...
  meanHeliocentricDistanceAu: requireObject("ganymede").distanceAu,
  presentation,
});
