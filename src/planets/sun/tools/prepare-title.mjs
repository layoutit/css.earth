...
import { SUN_TITLE_SOURCE } from "../source/presentation/title-mark.mjs";
...
await validateSunSourceGroup("title");
const title = createPreparedTitle(SUN_TITLE_SOURCE, {
  inputSha256: sha256(await readFile(sourcePath)),
  generator: "src/planets/sun/tools/prepare-title.mjs",
});
await writeFile(
  outputPath,
  serializePreparedTitleModule("PREPARED_SUN_TITLE", title),
);
