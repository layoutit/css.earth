...
Checked 2026-09-09. Selected DAMIT model [2012](https://damit.cuni.cz/projects/damit/asteroid_models/view/2012), version **2018-07-18**.
...
- Source, scalar and sampled surface-fit checks passed. [Validation report](../../../docs/mars-crossing-population/VALIDATION.md) · [Source fit](../../../docs/mars-crossing-population/evidence/lyyli-surface-fit.json) · [Source/result view](../../../docs/mars-crossing-population/evidence/lyyli-source-result.png).
...
- The competing model 2013 pole remains unresolved; selecting model 2012 does not establish a scientific preference.
