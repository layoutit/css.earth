...
The Io photographic starfield uses the 6000 x 3000 public equirectangular
...
single-epoch Io sky. The prepared Io scene therefore uses the image
...
not add or bake a Sun. The complete ESO credit is exposed in Io's source
resources.

## Astrometric registration (Io)
