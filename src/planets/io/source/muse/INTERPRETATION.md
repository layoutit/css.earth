...
Spectral slope is the released linear 477.5–495 nm slope after normalization at
495 nm, in µm⁻¹. The fixed display range is 4.4–6.6. Sulfur materials can affect
this slope; it is not sulfur-dioxide abundance or a uniquely identified species.

Visible absorption is the released mean continuum-removed depth over 520–660 nm,
with the 578–605 nm adaptive-optics gap omitted. Display range: 0.015–0.060. The
broad 560 nm feature has an uncertain chemical attribution. Neither map measures
a mineral percentage. Median absolute cross-night differences are about
0.16–0.19 µm⁻¹ for slope and 0.0031–0.0038 for absorption.
