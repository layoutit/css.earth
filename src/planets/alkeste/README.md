...
The [alkeste results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **59.73 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 4512, pole ['313', '11'], [Model 4512](https://damit.cuni.cz/projects/damit/asteroid_models/view/4512)
