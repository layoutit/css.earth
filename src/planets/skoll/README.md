...
Its **derived display semi-axes** are **2.509946 × 2.201707 × 2.201707 km**. Equal-volume scaling to the 2.3 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **7.26 ± 0.09 h · tentative** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 647, Saturn XLVII, **S/2006 S8**, resolves to **SAT456**. Mean elements establish identity and context.
