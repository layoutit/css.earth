...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. 7.26-hour solution is tentative and some data do not fit; no established wobble or binary interpretation. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire skoll
node tools/objects/dist/prepare-authored.js skoll --write
```
