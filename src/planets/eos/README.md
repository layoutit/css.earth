...
The [eos results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **443.48 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 1744, pole ['119', '-37'], [Model 1744](https://damit.cuni.cz/projects/damit/asteroid_models/view/1744)
