...
The [kriemhild results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **153.19 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 622, pole ['100', '-40'], [Model 622](https://damit.cuni.cz/projects/damit/asteroid_models/view/622)
