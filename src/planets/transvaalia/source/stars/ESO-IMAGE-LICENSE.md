...
The Ceres photographic starfield uses the 6000 x 3000 public equirectangular
...
single-epoch Ceres sky. The prepared Ceres scene therefore uses the image
...
not add or bake a Sun. The complete ESO credit is exposed in Ceres's source
resources.

## Astrometric registration (Ceres)
