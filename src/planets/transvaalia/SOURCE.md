# (715) Transvaalia: sources and interpretation

## Selected shape

[DAMIT model 3722](https://damit.cuni.cz/projects/damit/asteroid_models/view/3722), version 2019-05-07, from Ďurech et al. (2019), is a convex lightcurve inversion mesh. The original 574 vertices and 1144 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness. Concavities, craters, surface texture and exact current rotation phase are not resolved.
