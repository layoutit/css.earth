# (482) Petrina: source and interpretation
...
Hanuš, Delbo, Ďurech and Alí-Lagoa (2018), Table A.3, report a **volume-equivalent diameter of 44.2 ± 1 km** from varied-shape thermophysical modelling of WISE observations. The reported spread accounts for variations in the optical shape and spin solution. The physical scale is transferred to the nominal archived model from the same published shape/pole family; this does not claim that the nominal mesh is identical to every thermophysical realization.
...
- [DAMIT model record](https://damit.cuni.cz/projects/damit/asteroid_models/view/1152) — selected original mesh and spin metadata.
- [Original shape table](https://damit.cuni.cz/projects/damit/stored_files/open/4197/shape.txt) — counted XYZ vertices and one-based triangle indices.
