...
Orbital data: vendored JPL small-body orbital elements (`packages/astronomy`). Starfield: ESO/S. Brunier and HYG; see `source/stars/ESO-IMAGE-LICENSE.md` and `LICENSE.md`. Title: Inter under the SIL Open Font License, prepared using the shared title recipe. The navigation circle is an original cssEarth schematic under the project MIT license.
