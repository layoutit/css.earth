...
The [asia results](../../../docs/evidence/main-belt-asteroids/summary.json) record a maximum sampled source-to-display distance of **70.65 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 5669, pole ['286', '50'], [Model 5669](https://damit.cuni.cz/projects/damit/asteroid_models/view/5669)
