...
// Europa's Sun direction is the observed one, not a presentation constant:
...
// fact stay standard.
const bodyFixedDirection = requireBodyFixedSunDirection("europa");
const sceneDirection = EUROPA_PRESENTATION_FRAME.sunDirection;
...
await preparePlanetDirectionalSun({
  ...
  meanHeliocentricDistanceAu: requireObject("europa").distanceAu,
  presentation,
});
