...
Its **derived display semi-axes** are **6.712559 × 4.445404 × 4.445404 km**. Equal-volume scaling to the 5.1 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **28.15 ± 0.25 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 628, Saturn XXVIII, **S/2000 S10**, resolves to **SAT456**. Mean elements establish identity and context.
