...
The [lachesis results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **352.31 m**. This is a sampled comparison, not an exhaustive error bound.
