...
The [leto results](../../../docs/evidence/main-belt-asteroids/summary.json) record a maximum sampled source-to-display distance of **393.81 m**. This is a sampled comparison, not an exhaustive error bound.
