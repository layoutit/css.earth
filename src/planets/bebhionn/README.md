...
Its **derived display semi-axes** are **3.520768 × 2.496999 × 2.496999 km**. Equal-volume scaling to the 2.8 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **16.33 ± 0.03 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 637, Saturn XXXVII, **S/2004 S11**, resolves to **SAT456**. Mean elements establish identity and context.
