...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. Useful minimum elongation from the lightcurve; absolute scale remains albedo-dependent. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire bebhionn
node tools/objects/dist/prepare-authored.js bebhionn --write
```
