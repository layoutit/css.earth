...
The initial survey found no ready registered global map. The follow-up below registers an original L’LORRI observation to the released source model. Shape remains available with the ordinary grid; no unseen photograph, regolith or color is fabricated.
