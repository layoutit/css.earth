# 1998 ML14 sources and preparation

(52760) 1998 ML14 is a roughly kilometer-wide near-Earth asteroid. Its archived radar shape has a spheroidal body, a prominent bump and an indentation.
...
Every consumed source is pinned by byte length and SHA-256. Acquisition restores the unchanged source model, papers, ESO panorama and Inter font through recorded URLs. Articles retain publisher copyright and are restoration references; article pages are not runtime surface assets. Runtime installation consumes the published prepared package.
