...
import { URANUS_TITLE_SOURCE } from "../source/presentation/title-mark.mjs";
...
await validateUranusSourceGroup("title");
const title = createPreparedTitle(URANUS_TITLE_SOURCE, {
  inputSha256: sha256(await readFile(sourcePath)),
  generator: "src/planets/uranus/tools/prepare-title.mjs",
});
await writeFile(
  outputPath,
  serializePreparedTitleModule("PREPARED_URANUS_TITLE", title),
);
