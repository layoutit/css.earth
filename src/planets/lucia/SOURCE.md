# (222) Lucia: source and interpretation
...
The selected pole is (293°, 49°), with alternate (106°, 50°). Hanuš et al. (2018) show Lucia as an example where the thermophysical solution has no satisfactory constrained minimum; their accepted diameter table does not supply a shape-aware calibration. The AKARI effective diameter remains a qualified approximate scale.
