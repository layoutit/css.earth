...
The [felicitas results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **326.70 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 3096, pole ['252', '-49'], [Model 3096](https://damit.cuni.cz/projects/damit/asteroid_models/view/3096)
