# (217) Eudora: source and interpretation
...
The unmodified source has 564 vertices and 1124 triangles. Its signed tetrahedral volume is 0.9999999698225791 source units³; an independent triangle-centroid divergence sum gives 0.99999996982257899. The existing recipe applies one uniform scale of 54.646527790855416 km per source unit so its volume-equivalent diameter is 67.8 km. No unit-volume assumption is made. Radius above a 33.9 km sphere is a shape-derived scalar, not gravitational height or measured geology.

The original +Z spin axis and +X reference meridian are retained. The source pole is ecliptic J2000 (135°, -25°), with sidereal period 25.2626 h. Conversion to equatorial J2000 uses obliquity 23.439291111°. Absolute phase is arbitrary; accelerated display spin is illustrative. Position uses JPL Horizons heliocentric ICRF elements at 2026-09-03 TT (TDB approximated as TT, under 2 ms).
...
Gaia DR2 plus Lowell inversion; publication table gives 416 Lowell and 29 Gaia points. One pole is released; broad convex outline only.
...
The established source-meshoptimizer path retains source connectivity, reduces to at most 800 faces, and emits native PolyCSS `u` triangles with 128 px raster cells. The error allowance is 678 m; sampled source-fit error is qualified separately from source accuracy. Elevation uses closest-source-surface sampling with the same physical scale. Shadows are off by default. Shared runtime, camera, navigation and shell remain generic. Delivery and browser evidence are recorded in the PR’s validation report.
