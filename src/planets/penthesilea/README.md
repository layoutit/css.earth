...
The [penthesilea results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **184.00 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 934, pole ['42', '53'], [Model 934](https://damit.cuni.cz/projects/damit/asteroid_models/view/934)
