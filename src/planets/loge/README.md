...
Its **derived display semi-axes** are **2.463581 × 2.368828 × 2.368828 km**. Equal-volume scaling to the 2.4 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **6.9 ± 0.1 h · tentative** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 646, Saturn XLVI, **S/2006 S5**, resolves to **SAT456**. Mean elements establish identity and context.
