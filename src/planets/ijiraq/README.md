...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. Shallow lightcurve supports a modest equatorial constraint; polar dimension remains unknown. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire ijiraq
node tools/objects/dist/prepare-authored.js ijiraq --write
```
