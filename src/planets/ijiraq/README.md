...
Its **derived display semi-axes** are **6.736937 × 6.237905 × 6.237905 km**. Equal-volume scaling to the 6.4 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **13.03 ± 0.14 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 622, Saturn XXII, **S/2000 S6**, resolves to **SAT456**. Mean elements establish identity and context.
