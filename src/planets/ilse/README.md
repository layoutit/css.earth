...
The [ilse results](../../../docs/evidence/main-belt-asteroids-expansion/summary.json) record a maximum sampled source-to-display distance of **101.23 m**. This is a sampled comparison, not an exhaustive error bound.
...
The release supplies no registered surface imagery; the grid marks that gap. Alternative archive solutions: model 865, pole ['222', '41'], [Model 865](https://damit.cuni.cz/projects/damit/asteroid_models/view/865)
