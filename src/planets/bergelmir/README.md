...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. Modest elongation floor; lightcurve does not establish a polar axis. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire bergelmir
node tools/objects/dist/prepare-authored.js bergelmir --write
```
