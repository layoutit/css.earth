...
<a id="bergelmir-source-survey"></a>
...
Its **derived display semi-axes** are **2.712225 × 2.400199 × 2.400199 km**. Equal-volume scaling to the 2.5 km reference radius is a display convention, not a measured volume. Formula and assumptions are in source/measurements.json; the checked 5° radius table is the reproducible source input.
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **8.13 ± 0.09 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 638, Saturn XXXVIII, **S/2004 S15**, resolves to **SAT456**. Mean elements establish identity and context.
