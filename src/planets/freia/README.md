...
| --- | --- |
| Shape and spin | [DAMIT 442](https://damit.cuni.cz/projects/damit/asteroid_models/view/442) |
...
The [freia results](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/evidence/main-belt-asteroids/summary.json) record a maximum sampled source-to-display distance of **684.58 m**. This is a sampled comparison, not an exhaustive error bound.
...
The unmodified source has 1022 vertices and 2040 triangles. Its signed tetrahedral volume is 0.99999989141058354 source units³; an independent triangle-centroid divergence sum gives 0.99999989141058354. The existing recipe applies one uniform scale of 135.69748760087694 km per source unit so its volume-equivalent diameter is 168.36 km.

No unit-volume assumption is made. Radius above a 84.18 km sphere is a shape-derived scalar, not gravitational height or measured geology.

The original +Z spin axis and +X reference meridian are retained. The source pole is ecliptic J2000 (140°, 14°), with sidereal period 9.97306 h. Conversion to equatorial J2000 uses obliquity 23.439291111°. Position uses JPL Horizons heliocentric ICRF elements at 2026-09-03 TT (TDB approximated as TT, under 2 ms).
...
- [Selected model](https://damit.cuni.cz/projects/damit/asteroid_models/view/442) and [original counted mesh](https://damit.cuni.cz/projects/damit/stored_files/open/1721/shape.txt) — included unchanged. Convex light-curve inversion; fine relief is unresolved.
...
- [AKARI AcuA](https://data.darts.isas.jaxa.jp/pub/akari/AKARI-IRC_Catalogue_AllSky_AcuA_1.0/) — included as an explicitly approximate thermal size transfer. Its fitted nonrotating-sphere diameter is 168.36 ± 1.95 km. Formal catalog error omits additional shape, spin and thermal-model effects; no total confidence interval is invented.
...
The established source-meshoptimizer path starts from the source connectivity, reduces to at most 800 faces, and emits native PolyCSS `u` triangles with 128 px raster cells. The error allowance is 1683.6 m; sampled source-fit error is qualified separately from source accuracy.
