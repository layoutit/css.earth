...
Lightcurve-constrained minimum-elongation illustration through the generic object contract. Three maxima prevent treating an ellipsoid as a recovered physical outline. See [SOURCE.md](SOURCE.md) for the distinct physical estimates and display assumptions.
...
```sh
node tools/objects/dist/operations.js acquire hyrrokkin
node tools/objects/dist/prepare-authored.js hyrrokkin --write
```
