...
<a id="hyrrokkin-source-survey"></a>
...
The reported rotation period is an informational fact. Display meridian is arbitrary. Reported period **12.76 ± 0.03 h** remains separate from a measured current attitude. Zero GM is unmodeled mass, not a measured zero.

JPL 644, Saturn XLIV, **S/2004 S19**, resolves to **SAT456**. Mean elements establish identity and context.
