...
| --- | --- |
| Shape and spin | [DAMIT 515](https://damit.cuni.cz/projects/damit/asteroid_models/view/515) |
| Physical scale | [Calibration and uncertainty](source/reference/calibration.json) |

[DAMIT model 515](https://damit.cuni.cz/projects/damit/asteroid_models/view/515), version 2013-02-11, from Hanuš et al. (2013), is a convex lightcurve inversion mesh. The original 1022 vertices and 2040 triangular faces are preserved as the source input. Convex lightcurve inversion model; large-scale shape is inferred from disk-integrated brightness.

Concavities, craters, surface texture and exact current rotation phase are not resolved.

Adopted diameter: **31.962 ± 0.789 km**, meaning **effective body diameter**, from [Masiero et al. (2014), PDS NEOWISE Diameters and Albedos V2.0, reference codeMas14](https://doi.org/10.1088/0004-637X/791/2/121). The reference-sphere radius is 15.981 km. The quoted statistical error excludes the approximately 10% survey systematic floor (about 3.1962 km), shape/orientation effects and rotational sampling limitations.

## Evidence

<a id="provenance"></a>

The [moskva validation record](https://github.com/layoutit/cssEarth/blob/cc01831f595e0b73ab6699d6235cf7b466f76cfc/docs/asteroids-size-calibration-validation.json) contains source, scale, atlas, installation and browser results for its recorded files and revision.
...
Published alternate pole solutions remain plausible: model 516: λ=126°, β=27°, P=6.0558 h. The selected first archived solution is not asserted to be uniquely correct.
...
Model publication: [Asteroids' physical models from combined dense and sparse photometry and scaling of the YORP effect by the observed obliquity distribution](https://damit.cuni.cz/projects/damit/references/view/148).
...
DAMIT metadata report J2000 ecliptic pole λ=331°, β=59°, and rounded sidereal period 6.05581 h. The original IAUspin file uses equatorial pole α=308°, δ=43°, dW/dt=1426.729042°/day, W0=140° at JD 2451545.0. These are different frame conventions. The existing recipe uses the paired model-record ecliptic pole and period, with arbitrary display phase.
...
| [SBDB-selected two-band size 27.927 ± 0.507 km](https://ssd-api.jpl.nasa.gov/sbdb.api?sstr=787&phys-par=1) | excluded | Prefer later Masiero 2014 fully-cryogenic W3/W4 fit 31.962 ± 0.789 km with fitted beaming parameter and lower systematic floor; retain the different-epoch result as evidence of model/geometry dependence. |
