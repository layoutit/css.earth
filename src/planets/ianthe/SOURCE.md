# (98) Ianthe: source and interpretation
...
The unmodified source has 1022 vertices and 2040 triangles. Its signed tetrahedral volume is 0.99999984978234624 source units³; an independent triangle-centroid divergence sum gives 0.99999984978234624. The existing recipe applies one uniform scale of 84.017024850285381 km per source unit so its volume-equivalent diameter is 104.24 km. No unit-volume assumption is made. Radius above a 52.12 km sphere is a shape-derived scalar, not gravitational height or measured geology.

The original +Z spin axis and +X reference meridian are retained. The source pole is ecliptic J2000 (286°, 18°), with sidereal period 16.4801 h. Conversion to equatorial J2000 uses obliquity 23.439291111°. Absolute phase is arbitrary; accelerated display spin is illustrative. Position uses JPL Horizons heliocentric ICRF elements at 2026-09-03 TT (TDB approximated as TT, under 2 ms).
