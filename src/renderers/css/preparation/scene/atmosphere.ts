...
/** The scene record of a body with an atmosphere: its prepared frame atlases, the published disc law and the PSG halo. */
export function prepareAtmosphericMaterial(profile:GeometryProfile,raster:RasterRecipe,prepared:Awaited<ReturnType<typeof prepareAtmosphere>>,sunDirection:readonly number[]) {
 ...
 return {schema:profile.output.materialSchema,model:'published-disc-law-and-psg-limb-halo-phase-bank',
  ...
  presentationScale:material.coverageScale,materialScale:material.contentScale,outerRadiusScale:prepared.halo.outerRadiusScale,
  ...
  observationMaterial:{model:'published-disc-law-and-psg-limb-halo-for-false-colour-lenses',runtimeOpacity:false,runtimeRasterization:false},
