...
/** Node test fixture: the checked-in stellar neighbourhood manifest and bank, verified against their pins. */
export function readCanonicalPointFieldFiles(): { readonly descriptor: unknown; readonly url: string; readonly bankUrl: string;
  ...
  if (digest(manifestBytes) !== prepared.sha256) throw new TypeError('Checked-in point-field manifest drifted from its pin.');
