...
export interface PreparedSurfaceHit { readonly target: number; readonly triangles: readonly SurfaceTriangle[]; }
...
export function bindPreparedSurfaceHit(plan: PreparedSurfaceHit, target: HTMLElement, scene: HTMLElement,
  ...
  return (clientX, clientY) => {
    ...
    return rayHitsPreparedTriangles([eye.x, eye.y, eye.z], [ray.x, ray.y, ray.z], plan.triangles);
  };
}
