import type { DestinationReference, DestinationDirectory, DestinationSearch } from "./destination-types.js";
...
export function validateDestinationReference(ref: DestinationReference, capacity: number) {
...
export function validateDestinationDirectory(input: unknown, count: number): DestinationDirectory {
  const directory = input as DestinationDirectory;
...
export function validateDestinationSearch(input: unknown, count: number): DestinationSearch {
  const index = input as DestinationSearch;
