import type { DestinationSearch, DestinationResult } from "./destination-types.js";
import { normalizeDestinationQuery } from "./destination-query.js";
...
export function lowerBound(rows: ReadonlyArray<readonly [string, unknown]>, value: string) {
...
export function searchDestinationIndex(index: DestinationSearch, value: string, limit = 8): DestinationResult[] {
