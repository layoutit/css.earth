import type { PreparedPagePlan, PreparedPage, PreparedReference, PreparedDirectory } from "../../renderers/css/paging/types.ts";
interface DirectoryEntry { ref: PreparedReference; controller?: AbortController | null; data?: PreparedDirectory; started?: boolean; }
import { isPreparedCityAssetUrl } from "./city-asset-url.mts";
import { isPreparedBlockReference, readPreparedWmtsBlock, preparedReferenceKey } from "./prepared-block-transport.mts";
