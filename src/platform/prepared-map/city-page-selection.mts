import type { PreparedBounds, PreparedPage, PreparedPagePlan, PreparedReference, PageViewport, PageProjection, ProjectedPage, PageSelection } from "../../renderers/css/paging/types.ts";
import { preparedReferenceKey } from "./prepared-block-transport.mts";
...
function projectBounds(corners: readonly (readonly number[])[],matrix: readonly number[],scale: number){
