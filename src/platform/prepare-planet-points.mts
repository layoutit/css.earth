...
import { PREPARED_PLANET_POINT_SCHEMA } from "./planet-point-presentation.mts";
...
export function preparePlanetPoint({ radiusKilometers, geometricAlbedo, heliocentricDistanceAu, kilometersPerUnit }: { radiusKilometers: number; geometricAlbedo: number; heliocentricDistanceAu: number; kilometersPerUnit: number }) {
