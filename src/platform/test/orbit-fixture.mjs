...
const factory = new Function("dependencies", `const { createSceneLifetime, createPreparedCameraPublisher, HTMLElement,
  ...
  selectPreparedResponsiveZoom, viewSunDirectionToPreparedLightDirection, preparedScenePitch, clamp,
  createPerspectiveDolly, viewSunDirectionToPhysicalLightDirection, MutationObserver } = dependencies;
