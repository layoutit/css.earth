...
type RegisteredAnimation = Parameters<ReturnType<typeof createPreparedPlayback>["register"]>[0];
type AnimationFixture = { -readonly [Key in keyof RegisteredAnimation]: RegisteredAnimation[Key] } & { calls: string[] };
function animation(time = 12): AnimationFixture {
