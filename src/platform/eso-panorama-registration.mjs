...
export function fitPanoramaFrameRotation(anchors = ESO_PANORAMA_ANCHORS) {
  ...
  const pairs = anchors.map((anchor) => ({
    name: anchor.name,
    catalogue: directionFromDegrees(...anchor.galacticDegrees),
  ...
  return Object.freeze({
    ...
    maximumResidualDegrees: Math.max(...Object.values(residualsDegrees)),
...
function rotationFromVector([wx, wy, wz]) {
