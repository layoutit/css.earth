import type { RuntimePolicy, WheelInputKind } from "../renderers/css/navigation/runtime-policy.ts";
import type { NavigationCamera, TrackballMetrics, CameraDelta, ControlsUpdate } from "../renderers/css/navigation/types.ts";
export interface PreparedWheelZoomOptions { inputSurface: HTMLElement; camera: NavigationCamera; trackballMetrics(): TrackballMetrics; rotate(delta: CameraDelta): void; minimumZoom: number; maximumZoom: number; speedMultiplier?: number; useScrollDistance?: boolean; dolly?: { stepPerDelta: number } | null; onError?: ((error: unknown) => void) | null; }
...
import { WHEEL_ZOOM_SPEED_MULTIPLIER, WHEEL_ZOOM_DISCRETE_SPEED_MULTIPLIER,
  WHEEL_ZOOM_USE_SCROLL_DISTANCE, wheelZoomInputKind } from "../../site/runtime-policy.mts";
