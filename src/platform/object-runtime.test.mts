...
const runtimePolicy: RuntimePolicy = {
  ...
  WHEEL_ZOOM_DISCRETE_SPEED_MULTIPLIER: 1, WHEEL_ZOOM_PINCH: { wheelDeltaPerFingerLogStep: 100, touchWheelDeltaPerFingerLogStep: 400, fullPinchFingerRatio: 5, nearRemainingPerFullPinch: .6, farZoomPerFullPinch: 50 }, WHEEL_ZOOM_INERTIA: null, WHEEL_ZOOM_INERTIA_INPUT_KINDS: [],
