import type { CubicSkyPlan } from "../renderers/css/solar-system/cubic-sky-runtime.ts";
import type { CameraPlan, CameraAngles, CameraPose, Quaternion, Vector3 } from "../renderers/css/navigation/types.ts";
...
import { rotationAxisAngle } from "./destination-flight.mts";
...
export function createCubicSkyCameraOrientation({
  ...
  return Object.freeze({
    ...
    prepareFlight(target: CameraAngles & { controlRoll?: number }) {
    ...
    counterRotation(localMatrix: string | DOMMatrix | null = null) {
