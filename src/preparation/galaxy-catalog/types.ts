import type { PreparedGalaxyRecord, PreparedGalaxyCatalog as Catalog } from '@cssearth/catalog';
export type Vec3 = [number, number, number];
export interface SourcePin { path: string; sha256: string; bytes: number }
export interface GalaxySource extends SourcePin { id: string; url: string; citation: string }
