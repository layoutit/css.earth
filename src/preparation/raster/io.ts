...
export const outputName = (template: string, id = '') => template.replaceAll('{id}', id);
...
export const assetPath = (directory: string, template: string, id = '') => resolve(directory, outputName(template, id));
