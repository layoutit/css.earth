...
import { compareShapeSignal, comparisonPixels, type NeutralProjection } from './comparison.js';
import { comparisonChannels, comparisonGains } from './comparison-result.js';
import type { ShapeCloudComparison, ShapeCloudComparisonLevel, ShapeCloudPin } from './types.js';
