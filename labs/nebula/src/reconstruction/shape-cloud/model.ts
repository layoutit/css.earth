...
import type { GeometryCandidate, GeometryMap } from '../../alignment/observations-ui/geometry-model.js';
import { ellipsePoint, radialError } from '../geometry/ellipse.js';
import type { ShapeCloudComponent, ShapeCloudSettings } from './types.js';
