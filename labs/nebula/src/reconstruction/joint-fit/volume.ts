...
import { bakeMasterVolumeSlices, type MasterSliceProgress } from '../master-slices.js';
import type { JointVolumeResult } from './volume-model.js';

export type { JointVolumePin, JointVolumeResult } from './volume-model.js';
