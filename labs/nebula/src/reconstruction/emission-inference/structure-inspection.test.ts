...
import { createSupportAtlases } from './structure-atlas.js';
import { workingRasterToFrame } from './structure-inspection.js';
import { applyAffine, type Affine } from '../../alignment/observations/registration.js';
import type { StructureRegion } from '../structure-wavelets.js';
