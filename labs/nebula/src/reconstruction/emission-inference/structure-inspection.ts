...
import { analyzeStructureMap, colorStructureLayer, structureLayers } from './structure-map.js';
import { createSupportAtlases } from './structure-atlas.js';
import type { WaveletSettings } from '../structure-wavelets.js';
import { composeAffine, type Affine } from '../../alignment/observations/registration.js';
