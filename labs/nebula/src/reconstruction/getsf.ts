...
import { encodeFits, float32LittleEndian } from './getsf-fits.js';
...
export async function prepareGetSfBenchmark(options: GetSfInput) {
  ...
  const metadata = {
    ...
    OBJECT: 'DISPLAY IMAGE - NOT CALIBRATED', ORIGIN: 'SMASH display-image structure benchmark',
