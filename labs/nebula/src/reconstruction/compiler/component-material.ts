...
import { createEmissionField, emissionKernel, prepareEmissionComponent } from './field';
import type { EmissionFieldModel, EmissionVector3 } from './field-types';
import type { CompilerImage } from './images';

const QUADRATURE_STEPS = 24;
type MaterialImage = Pick<CompilerImage, 'id' | 'sampleRgb'>;
