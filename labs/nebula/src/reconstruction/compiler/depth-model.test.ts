...
import { conditionDepthComponents, depthSurfaceAt, readDepthRecipe, verifyDepthEvidence, loadDepthModel, type DepthRecipe, type DepthSurface } from './depth-model';
import { createEmissionField, projectEmissionComponent } from './field';
import { fitEmissionField } from './fit';
import type { EmissionComponent, EmissionFieldModel, EmissionFitInput } from './field-types';
