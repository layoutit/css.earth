...
import { decodeFits, encodeFits } from '../getsf-fits';
import type { EmissionVector3 } from '../compiler/field-types';
import { analyticEmission, mapSample, prepareSampledField } from './field';
import { readSampledRecipe, verifySampledEvidence, type SampledRecipe, type SampleTerm } from './model';
