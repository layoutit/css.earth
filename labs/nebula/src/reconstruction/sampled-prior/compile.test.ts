...
import { compilerFrame, type CompilerStarInput } from '../compiler/bake';
import { readCompilerBakeResult, validCompilerStarSprites, type PreparedCompilerStar } from '../compiler/bake-types';
import { COMPILER_STAR_PROFILE_PATH, prepareCompilerStarSprites } from '../compiler/star-sprites';
import { prepareSampledSceneStars } from './compile';
