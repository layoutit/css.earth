...
import type { EmissionBounds, EmissionVector3 } from '../compiler/field-types';
import type { SampledRecipe, SampleTerm, ComponentWeights } from './model';
...
export function prepareSampledField(values: Float32Array, recipe: SampledRecipe, signal?: AbortSignal) {
  ...
  const rawBounds = structuredClone(bounds);
