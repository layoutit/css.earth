import { createCompilerStarPhotometer, compilerStarLensPoints, detectCompilerStarCandidates } from '../compiler/stars';
import type { CompilerImage } from '../compiler/images';
import type { CompilerStarInput } from '../compiler/bake';
import type { CompilerStarMaterial } from '../compiler/bake-types';
import type { SpatialField } from './field';
import type { SampledRecipe } from './model';
