...
import type { PreparedSampledField } from './field';
import type { SampledRecipe, ComponentWeights } from './model';
import { diffuseAtomEmission } from './emission-fit';
import { prepareSampledMaterial, diffuseMaterialColors, type SampledMaterialFit } from './material';
