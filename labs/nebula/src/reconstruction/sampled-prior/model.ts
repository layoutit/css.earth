...
function pin(v: unknown): SamplePin {
  if (!jointRecord(v) || !jointPath(v.path) || !/^(labs\/nebula\/models\/|\.local\/nebula-lab\/)/.test(v.path) ||
...
export function readSampledRecipe(v: unknown): SampledRecipe {
