...
} else if (['browser-catalogue-surveys', 'browser-catalogue-fits', 'acquire-messier-presentation', 'enrich-messier-catalogue', 'inventory-messier', 'acquire-messier', 'prepare-nebula-objects', 'browser-catalogue', 'browser-candidate-published', 'browser-candidate-workspaces', 'compile-candidates', 'compile-nebula', 'browser-compiler', 'molecular-acquire', 'prepare-joint-fit', 'browser-joint-fit', 'prepare-kinematics', 'browser-multimodal', 'browser-shape-cloud-fit', 'browser-geometry-controls', 'browser-shape-cloud-structure', 'browser-shape-cloud-rotation', 'browser-shape-cloud-cache', 'browser-shape-cloud-pose', 'browser-shape-cloud', 'browser-shape-cloud-api', 'prepare-observation-geometry', 'browser-observation-structures', 'prepare-observation-structures', 'prepare-observations', 'browser-observation-alignment', 'browser-nebula-structures', 'prepare-nebula-structures', 'browser-emission', 'prepare-emission', 'verify-nebula', 'bake-nebula', 'promote-volume-lenses', 'browser-removal-strength', 'prepare-overlay-variants', 'browser-overlay-variants', 'prepare-lmc-stars', 'browser-cloud-density', 'browser-cloud-controls', 'prepare-parts', 'browser-filled', 'prepare-filled', 'browser-overlays', 'prepare-overlays', 'prepare-full-density', 'browser-density', 'prepare-particles', 'prepare-master', 'prepare-coherent', 'prepare-prior-window',
