...
import { imageRank, rankImages } from './image-ranking';
import { footprintCoverage } from './footprint';
import type { MessierObject } from './types';

const m31: MessierObject = { id:'m31',messier:31,name:'Andromeda',aliases:[],type:'galaxy',raDegrees:10.6847083,decDegrees:41.26875,majorArcmin:199.53,minorArcmin:null,sourceIds:[] };
