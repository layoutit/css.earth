...
import { createCompilerViewer, type CompilerMaterial, type CompilerViewer } from '../viewer/compiler-viewer';
import { compilerInspectionCamera, type CompilerInspectionFrame } from '../viewer/compiler-framing';
import type { CloudView } from './shape-cloud-stage';
import './shape-cloud.css';

export type { CloudView } from './shape-cloud-stage';
