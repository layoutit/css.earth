...
import { bakePhotoConstrainedEmission } from '../reconstruction/photo-emission.js';
import type { PhotoEmissionOptions, PhotoEmissionDiagnostics } from '../reconstruction/photo-emission.js';
...
export async function convertParticlesToDensityVolume(options: ParticleVolumeOptions): Promise<ParticleVolumeReceipt> {
