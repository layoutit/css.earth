...
import { prepareGetSfBenchmark, type GetSfInput } from './getsf.js';
import { collectGetSfBenchmark } from './getsf-collect.js';
...
const installation = JSON.parse(await readFile(installationReceiptPath, 'utf8'));
