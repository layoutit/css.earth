...
import { createObservationMapping, reprojectObservationPrior } from '../density/observation-prior.js';
import type { ImageWcs } from '../alignment/overlay-wcs.js';
import { decomposeFilledComponents, type FilledComponentOptions } from '../reconstruction/filled-components.js';
import { createFilledVolumeSampler } from '../reconstruction/filled-volume.js';
import { rectifyObservation, writeObservationPanel, extendedMap, validateObservationProjection } from '../reconstruction/filled-products.js';
import { bakeMasterVolumeSlices, deriveMasterVolumeSlices } from '../reconstruction/master-slices.js';
import { validateCoherentAxisSampling } from '../reconstruction/coherent-validation.js';
...
const pins = Object.fromEntries(await Promise.all(['cli/prepare-filled.ts', 'reconstruction/filled-products.ts', 'reconstruction/filled-components.ts',
  'reconstruction/filled-volume.ts', 'density/observation-prior.ts', 'alignment/overlay-wcs.ts', 'alignment/overlay-geometry.ts', 'reconstruction/master-slices.ts'].map(async name =>
