...
> Historical classical-removal record. The app now uses [automatic NOX removal](../../../docs/star-removal.md) and [explicit reconstruction processing](../../../docs/reconstruction.md). These receipts remain provenance; replaying this experiment is not part of normal usage.
...
.local/nebula-lab/registration/venv/bin/python labs/nebula/src/star-removal/process-image-candidates.py labs/nebula/models/lmc/star-separation/plan.json
