...
p=Path('.local/nebula-lab/amateur-candidates/naztronomy/registration'); src,sn=r.load('.local/nebula-lab/amateur-candidates/naztronomy/naztronomy-optical.jpg',5000);ref,rn=r.load('.local/nebula-lab/source-originals/noirlab2030a.tif',5000)
# Remove diffuse light at every working scale, before descriptor extraction.
for sd,rd in [(3000,3500),(2400,2400),(2000,3000)]:
 def work(im,d):
