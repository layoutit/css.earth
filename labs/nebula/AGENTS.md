...
- Inference subjects add a cloud workbench in **Shapes**, reachable through **Cloud preview** from the detected-line inspector. Large **Compare / Overlay / Textured** buttons inspect the same cloud. Hover/click guides to inspect/select components; **All / Group / Selected** scopes edit saved drafts. Press **Preview / Update preview** to apply them; changing modes or controls alone never bakes. Keep pending draft guides distinguishable from the completed volume.
