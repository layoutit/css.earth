...
- **[Alignment](http://127.0.0.1:4331/?subject=lmc-particles&tab=alignment)**: rotate the LMC/SMC simulated stellar field, compare seven LMC references including the 24° DSS2 optical field in the floating right panel; adjust neutral density in the floating left panel. Brightness, gamma, black/white levels, and image alignment controls stay visible. Shared inspection controls live in the header. The default camera is at the solar observer. Fits survive reloads. [Image coverage](docs/image-coverage.md) · [Preparation and limitations](docs/workflows.md#independent-density-and-image-overlays).
