...
- **[Reconstruction](http://127.0.0.1:4331/?subject=lmc-clouds&tab=reconstruction)**: inspect the colored 3D cloud made from registered image structure and the stellar density prior. The LMC cloud pair compares finite connected depth with a broad-depth control; source separation panels remain beside its preparation evidence. [Method, evidence, and limits](docs/filled-observation.md).
