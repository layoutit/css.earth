...
The active LMC Alignment selector now uses the [review shortlist](../image-candidates.md): SMASH, corrected VISTA, WISE, DSS2, Horálek, the wider published SMASH mosaic, Ciel Austral and Naztronomy optical previews. DSS2 and Horálek have been restored to the active comparison catalogue; no reconstruction was replaced.
