# Rejected fixed-benchmark material experiment

Historical only. This experiment preserved an older photo-derived cloud, not the density object shown in Alignment, and incorrectly removed the saved Alignment fit. Its self-consistency checks did not catch the cross-tab mismatch.
