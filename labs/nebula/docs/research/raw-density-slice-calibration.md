# Historical raw-density material experiment

This rejected experiment predates the fixed-benchmark painter. Its measurements remain evidence for that older pipeline; they are not the current geometry or material contract.
