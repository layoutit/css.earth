...
- The same1024×1024 native SMASH crop feeds wavelets and getsf. Its checked PNG hash and full TIFF/crop provenance are in `models/structure-benchmark.json`.
