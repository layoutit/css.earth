...
The [compiler](../src/reconstruction/compiler/compile.ts), [projected fitter](../src/reconstruction/compiler/fit.ts), [field](../src/reconstruction/compiler/field.ts), [image target](../src/reconstruction/compiler/images.ts) and [joint scaffold fitter](../src/reconstruction/joint-fit/fitter.ts) establish these boundaries:
