...
Large originals and lossless intermediates stay in the ignored `.local/nebula-lab/` cache. Recipes, source receipts, registration evidence and original-image inspection previews are versioned. Starless/residual previews and density/app slice textures are regenerated by the bake and ignored.
