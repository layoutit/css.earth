...
export function createCloudStarControls({ host, controls, onChange }: {
  host: HTMLElement; controls: ControlPortals; onChange(options: CloudStarOptions): void;
}) {
  ...
  return {
    ...
    getValue: () => ({ ...options }),
    destroy() { destroyed = true; context = null; root.unmount(); },
  };
}
