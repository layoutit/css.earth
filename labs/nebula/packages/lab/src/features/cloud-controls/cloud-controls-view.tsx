...
export function createCloudControls({ host, controls, onChange, onBrightness }: {
  host: HTMLElement; controls: ControlPortals; onChange(selection: CloudSelection): void; onBrightness(balance: CloudBrightness): void;
}) {
  const root = controls.mount(host);
  ...
  return Object.freeze({
    ...
    destroy() { destroyed = true; if (copyTimer !== undefined) window.clearTimeout(copyTimer); context = null; root.unmount(); },
  });
}
