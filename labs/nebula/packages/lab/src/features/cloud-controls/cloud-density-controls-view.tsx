...
export function createCloudDensityControls({ host, controls, onApply }: {
  host: HTMLElement; controls: ControlPortals;
  ...
  return Object.freeze({
    ...
    getValue: () => ({ ...filter }),
    destroy() { destroyed = true; generation++; pending?.abort(); if (copyTimer !== undefined) window.clearTimeout(copyTimer); root.unmount(); },
  });
}
