...
import type { ShapeCloudComponent, ShapeCloudMode } from './types.ts';
import { formatShapeExpression, parseShapeExpression } from '../../server/workflows/shape-cloud/expression.ts';
...
import type { ShapeCloudPreset } from '../../server/workflows/shape-cloud/presets.ts';
