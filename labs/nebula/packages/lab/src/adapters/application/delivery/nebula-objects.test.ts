...
async function fixture(root: string) {
  ...
  for (const directory of ['tools/nebula/application','packages/bake/src/volume','packages/bake/src/volume-leaves','packages/renderer/src/volume','packages/bake/src/density']) {
