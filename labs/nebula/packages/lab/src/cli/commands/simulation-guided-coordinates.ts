/** Offline observer-ray adapter between physical kpc and the compiler's angular tangent frame. */
import type { EmissionBounds, EmissionVector3 } from '@cssearth/volume-core/contracts/emission';
