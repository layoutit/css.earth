...
function project(ra: number, dec: number, object: ArchiveTarget): Point | null {
...
export function footprintCoverage(image: ArchiveImage, object: ArchiveTarget, majorArcsec: number | null) {
