...
def main():
    ...
    for j, k in enumerate(choices):
        ...
        cv2.putText(sheet, f'heldout #{k}: {args.source_id} | {args.reference_id}  {residual[k]:.2f}px', (col*320+3, row*180+14), cv2.FONT_HERSHEY_SIMPLEX, .33, (255,255,255), 1)
