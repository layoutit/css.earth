...
request number, the object id and its kind). It rebakes your branch, fails if
the rebake does not reproduce the inventory you committed, and uploads the
bytes. Nothing needs to be pushed to your branch, and no maintainer has to
reproduce your setup locally.
