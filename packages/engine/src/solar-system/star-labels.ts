...
export function selectStarLabel({ stars, rotation, focal, principalOffset, visibleRect, exposure }: StarLabelView) {
  const magnitudeLimit = magnitudeForRadiusPx(exposure, HINT_RADIUS_PX) + STAR_LABEL_POLICY.magnitudeOffset;
  let selected: CatalogueStar | null = null;
