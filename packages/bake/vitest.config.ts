...
export default defineConfig({
  test: {
    ...
    exclude: [...configDefaults.exclude, 'src/scene/scene.test.ts', 'src/presentation/*.test.ts', 'src/volume-leaves/*.test.ts', 'src/stars/*.test.ts', 'src/shell/*.test.ts', 'src/sky/*.test.ts', 'src/density/*.test.ts'],
  },
});
