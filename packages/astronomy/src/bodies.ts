...
export type TransNeptunianId = 'arrokoth' | 'quaoar' | 'gkunhomdima'
export type SmallBodyId = AsteroidId | TransNeptunianId
export type BodyId = 'sun' | PlanetId | 'moon' | SatelliteId | SceneSatelliteId | DwarfPlanetId | AsteroidId | TransNeptunianId | CometId
...
export const TRANS_NEPTUNIAN_IDS: readonly TransNeptunianId[] = ['arrokoth', 'quaoar', 'gkunhomdima']
export const SMALL_BODY_IDS: readonly SmallBodyId[] = [...ASTEROID_IDS, ...TRANS_NEPTUNIAN_IDS]
