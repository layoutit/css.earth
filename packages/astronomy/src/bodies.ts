...
export type TransNeptunianId = 'arrokoth' | 'quaoar' | 'gkunhomdima' | 'sedna' | 'gonggong' | 'orcus' | 'salacia' | 'varuna' | 'varda' | 'mani' | 'achlys' | 'ixion' | 'huya' | 'asteroid-2003-vs2' | 'asteroid-2002-tc302' | 'asteroid-2002-tx300' | 'deedee'
...
export const TRANS_NEPTUNIAN_IDS: readonly TransNeptunianId[] = ['arrokoth', 'quaoar', 'gkunhomdima', 'sedna', 'gonggong', 'orcus', 'salacia', 'varuna', 'varda', 'mani', 'achlys', 'ixion', 'huya', 'asteroid-2003-vs2', 'asteroid-2002-tc302', 'asteroid-2002-tx300', 'deedee']
