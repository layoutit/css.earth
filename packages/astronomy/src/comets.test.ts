...
describe('comet positions against independent JPL Horizons vectors', () => {
  ...
  const regressionGuardKm = { 'comet-67p': 380, 'comet-103p': 450, 'comet-9p': 6000, 'comet-81p': 555, 'comet-1p': 642, 'comet-8p': 505, 'comet-19p': 410, 'comet-137p': 397, 'comet-143p': 1713, 'comet-162p': 800, 'comet-2p': 275, 'comet-209p': 524 }
