...
describe('comet positions against independent JPL Horizons vectors', () => {
  ...
  // Observed maxima: 67P 329.06 km; 103P 390.29 km; 9P 5181.10 km; 81P 480.81 km.
  // The per-body regression guards add approximately 15% headroom.
  const regressionGuardKm = { 'comet-67p': 380, 'comet-103p': 450, 'comet-9p': 6000, 'comet-81p': 555 }
