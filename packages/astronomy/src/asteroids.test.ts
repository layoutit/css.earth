...
describe('asteroid positions against JPL Horizons', () => {
  ...
  it('bounds the measured propagation error at the two independent nearby dates', () => {
    ...
    const maximumErrorKm = {vesta: 300, eros: 200, itokawa: 400, bennu: 200, ryugu: 200, ida: 2000, gaspra: 850, mathilde: 230, lutetia: 200, steins: 220, didymos: 140, kleopatra: 250, toutatis: 340}
