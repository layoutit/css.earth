...
import { SCENE_EPHEMERIS_DIRECTORY, loadSceneEpochEphemeris } from './scene-ephemeris.mjs';
...
const temporary = await mkdtemp(new URL('.acquire-', SCENE_EPHEMERIS_DIRECTORY));
try {
