...
const cell = (overlap: number, texelsPerUnit: number) =>
  createSurfacePatches(profile, overlap, texelsPerUnit).find(patch => patch.longitudeIndex === 3 && patch.latitudeIndex === 5)!;
