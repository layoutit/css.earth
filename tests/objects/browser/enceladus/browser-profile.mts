...
export const browserProfile = createObjectBrowserProfile({ id: "enceladus", controls: objectControls,
  audit: {
    canonicalPreparedAssets: ["/scenes/enceladus/enceladus-normal-surface@2x.webp", "/scenes/enceladus/enceladus-lighting.webp", "/scenes/enceladus/enceladus-directional-sun@2x.webp"],
