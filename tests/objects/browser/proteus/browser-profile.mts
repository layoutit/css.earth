...
export const browserProfile = createObjectBrowserProfile({ id: 'proteus', controls: objectControls,
  audit: {
    canonicalPreparedAssets: ['/scenes/proteus/proteus-normal-surface@2x.webp', '/scenes/proteus/proteus-lighting.webp', '/scenes/proteus/proteus-directional-sun@2x.webp'],
