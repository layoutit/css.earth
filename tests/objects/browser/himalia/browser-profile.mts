...
export const browserProfile=createObjectBrowserProfile({id:'himalia',controls:objectControls,audit:{
  canonicalPreparedAssets:['/scenes/himalia/himalia-model-surface@2x.webp','/scenes/himalia/himalia-lighting.webp','/scenes/himalia/himalia-directional-sun@2x.webp'],
