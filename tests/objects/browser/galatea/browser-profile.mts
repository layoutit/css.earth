...
export const browserProfile=createObjectBrowserProfile({id:'galatea',controls:objectControls,audit:{
  canonicalPreparedAssets:['/scenes/galatea/galatea-model-surface@2x.webp','/scenes/galatea/galatea-lighting.webp','/scenes/galatea/galatea-directional-sun@2x.webp'],
