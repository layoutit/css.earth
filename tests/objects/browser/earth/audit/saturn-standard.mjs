...
const report = {
  ...
  sourceFingerprints: await fingerprints({
    ...
    earthRuntime: "src/planets/earth/prepared/runtime.json",
    ...
    saturnRuntime: "src/planets/saturn/prepared/runtime.json",
    saturnStyles: "src/renderers/css/styles/saturn-surfaces.css",
    saturnLenses: "src/planets/saturn/prepared/lenses.json",
    saturnMoons: "src/planets/saturn/source/moons/saturn-moons.json",
