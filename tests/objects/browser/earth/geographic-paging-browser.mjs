...
const { preparePlaceCatalog } = await import("../../../../tools/objects/geographic-pages/places.mjs");
...
const viewpoints = [
  ...
  camera: prepareLocationCamera(PREPARED_EARTH_SCENE, prepareLocationPoint(PREPARED_EARTH_SCENE, longitude, latitude), zoom, {body:PREPARED_EARTH_SCENE[earthPreparationConfig.sceneBodyKey],camera:earthPreparationConfig.camera}) }));
