...
for(const sample of samples){
  ...
  sample.camera=prepareLocationCamera(PREPARED_EARTH_SCENE,
    prepareLocationPoint(PREPARED_EARTH_SCENE,sample.longitude,sample.latitude),1024, {body:PREPARED_EARTH_SCENE[earthPreparationConfig.sceneBodyKey],camera:earthPreparationConfig.camera});
}
