...
for(const sample of samples){
  ...
  sample.camera=prepareLocationCamera(scene,prepareLocationPoint(scene,sample.longitude,sample.latitude),1024*2**(tileZoom-12), {body:scene[earthPreparationConfig.sceneBodyKey],camera:earthPreparationConfig.camera});
}
...
export default {...base,vite:{...base.vite,plugins:[{name:"prepared-wmts-diagnostic",enforce:"pre",transform(code,id){
