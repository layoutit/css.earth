...
export const browserProfile = createObjectBrowserProfile({ id: 'calypso', controls: objectControls,
  audit: {
    canonicalPreparedAssets: ['/scenes/calypso/calypso-normal-surface@2x.webp', '/scenes/calypso/calypso-lighting.webp', '/scenes/calypso/calypso-directional-sun@2x.webp'],
