...
export const browserProfile=createObjectBrowserProfile({id:'hyrrokkin',controls:objectControls,audit:{
  canonicalPreparedAssets:['/scenes/hyrrokkin/hyrrokkin-model-surface@2x.webp','/scenes/hyrrokkin/hyrrokkin-lighting.webp','/scenes/hyrrokkin/hyrrokkin-directional-sun@2x.webp'],
