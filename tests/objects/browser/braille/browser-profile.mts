...
export const browserProfile=createObjectBrowserProfile({id:'braille',controls:objectControls,audit:{
  canonicalPreparedAssets:['/scenes/braille/braille-model-surface@2x.webp','/scenes/braille/braille-lighting.webp','/scenes/braille/braille-directional-sun@2x.webp'],
