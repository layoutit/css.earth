...
export const browserProfile = createObjectBrowserProfile({ id: 'comet-67p', controls: objectControls,
  audit: {
    canonicalPreparedAssets: ['/scenes/comet-67p/comet-67p-model-surface@2x.webp', '/scenes/comet-67p/comet-67p-lighting.webp', '/scenes/comet-67p/comet-67p-directional-sun@2x.webp'],
