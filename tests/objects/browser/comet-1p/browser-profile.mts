...
export const browserProfile = createObjectBrowserProfile({ id: 'comet-1p', controls: objectControls,
  audit: {
    canonicalPreparedAssets: ['/scenes/comet-1p/comet-1p-model-surface@2x.webp', '/scenes/comet-1p/comet-1p-lighting.webp', '/scenes/comet-1p/comet-1p-directional-sun@2x.webp'],
