...
const root=resolve(import.meta.dirname,'../../../../src/planets/phobos/source');
test('phobos published mesh preserves axes, units, seam and polar samples',async()=>{
 ...
 for(const [lon,lat,expected] of [[0, 0, 12533.906071], [90, 0, 11852.380973], [180, 0, 12847.932125], [270, 0, 11293.046229], [0, 90, 9867.899056], [0, -90, 8153.026985]]) {
 ...
 for(const lon of [0,90,180,270]) {
  ...
  if(height!==null)assert.ok(Math.abs(height-(mesh.sample(lon,0)/1000-11.1))<.001);
 }
});
