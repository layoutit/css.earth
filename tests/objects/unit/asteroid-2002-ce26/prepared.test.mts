...
test('2002 CE26 Primary retains Shape, Elevation and native raster triangles',async()=>{
 ...
 const surfaces=requireRecord(JSON.parse(await readFile(new URL('../../../../src/objects/asteroid-2002-ce26/prepared/surfaces.json',import.meta.url),'utf8')),'prepared surfaces');
