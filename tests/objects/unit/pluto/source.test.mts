...
import { readPlutoFacts, parsePlutoFacts } from "./preparation-fixture.mts";
import { decodeElevationGrid, elevationColor, elevationRaster } from "./preparation-fixture.mts";
...
test("decodes signed USGS elevation and preserves missing observations", async () => {
  const bytes = await readFile(new URL("../../../../src/planets/pluto/source/lenses/pluto-dem.tif", import.meta.url));
  ...
  const label = await readFile(new URL("../../../../src/planets/pluto/source/lenses/pluto-dem.lbl", import.meta.url), "utf8");
