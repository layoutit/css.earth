...
import descriptor from "../../../../src/planets/titan/prepared/features.json" with { type: "json" };
...
test("the prepared Titan nomenclature catalogue is pinned by the runtime plan and the provenance descriptor", () => {
  ...
  assert.equal(plan.catalog.count, 291, "the unchanged features recipe keeps the terrestrial-lane count");
