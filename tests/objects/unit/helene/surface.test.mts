...
const source = resolve(import.meta.dirname, '../../../../src/objects/helene/source');

test('Helene released plate mesh preserves PDS units, axes and vertex indices', async () => {
  ...
  for (const [longitude, latitude, expected] of [[0, 0, 20111.3], [90, 0, 19490.4525359262], [180, 0, 19827.56861064636], [270, 0, 18804.480331088092], [0, 90, 12347.2], [0, -90, 15257.199999999999]] as const) {
