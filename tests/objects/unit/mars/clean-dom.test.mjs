...
test("keeps the Mars scene as one fixed retained PolyCSS tree", async () => {
  ...
  const { retainedPresentationFixture } = await import("../../../../src/platform/test/object-runtime-package.mjs");
  ...
  try {
    ...
    const { PREPARED_MARS_CAMERA } = await import("../../unit/mars/prepared-fixture.mjs");
