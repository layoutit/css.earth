...
const source = resolve(import.meta.dirname, '../../../../src/objects/telesto/source');

test('Telesto released plate mesh preserves PDS units, axes and vertex indices', async () => {
  ...
  for (const [longitude, latitude, expected] of [[0, 0, 16242.9], [90, 0, 11695.460039093523], [180, 0, 15771.425423927938], [270, 0, 10972.790975076956], [0, 90, 8321.1], [0, -90, 10356.3]] as const) {
