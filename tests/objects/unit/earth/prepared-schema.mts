...
export const parseEarthScene=shape({schema:text,
  ...
  earth:shape({equatorialRadiusKm:number,polarRadiusKm:number,obliquityDegrees:number,surfaceRotationSeconds:number,presentationNodeDegrees:number,
    meshRotationDegrees:number,systemTransform:text,meshTransform:text,faceRetention:text}),
