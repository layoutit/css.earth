...
import { prepareAdministrativePlaces, principalNavigationBounds } from "../../../../tools/objects/geographic-pages/operations/prepare-administrative-places.mjs";
import { PREPARED_EARTH_SCENE, earthPreparationConfig } from "../../unit/earth/prepared-fixture.mjs";
...
function fixture() {
  ...
  return { countryRows: [country], adminRows: [["AR.05", "Córdoba", "Cordoba", "3860255"]],
    ...
    cameraOptions: {body:PREPARED_EARTH_SCENE[earthPreparationConfig.sceneBodyKey],camera:earthPreparationConfig.camera} };
}
