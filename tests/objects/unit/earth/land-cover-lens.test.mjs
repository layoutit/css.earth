...
import { PREPARED_EARTH_LAND_COVER_DESCRIPTOR as descriptor } from "../../unit/earth/prepared-fixture.mjs";
import { PREPARED_GEOGRAPHIC_LENSES, PREPARED_ROOT_GEOGRAPHIC_LENSES, earthSourceDirectory, earthPreparationConfig, objectControls } from "../../unit/earth/prepared-fixture.mjs";
import { preparePlaceCatalog } from "../../../../tools/objects/geographic-pages/places.mjs";
import { prepareOverlayCapacity } from "../../../../tools/objects/geographic-pages/operations/geographic-overlay.mjs";
import { PREPARED_EARTH_SCENE as scene } from "../../unit/earth/prepared-fixture.mjs";
import { prepareTreeSection } from "../../../../tools/objects/geographic-pages/prepare-wmts-tree.mjs";
import { prepareWmtsTile } from "../../../../tools/objects/geographic-pages/wmts-page-geometry.mjs";
import { requireGeographicLensPackage } from "../../../../src/renderers/css/dist/testing.js";
import { requireGeographicRoots, requireGeographicDirectory } from "../../../../src/renderers/css/dist/testing.js";
import { readPreparedWmtsBlock } from "../../../../src/renderers/css/dist/testing.js";
import { readPreparedJson } from "../../../../src/renderers/css/dist/testing.js";
import { bindPreparedWmtsRaster, requireWmtsRasterSource, isPreparedProviderWmtsImage } from "../../../../src/renderers/css/dist/testing.js";
import { createApiImageTransport as createTransport } from "../../../../src/renderers/css/dist/testing.js";
...
test("Earth owns land cover and no country, region or city inherits it", async () => {
  const catalog = await preparePlaceCatalog({sourceDirectory:earthSourceDirectory,config:earthPreparationConfig,scene,inventory:PREPARED_GEOGRAPHIC_LENSES,defaultLens:objectControls.lenses.defaultLens});
...
test("the exact transparent provider sentinel is no-data; different one-pixel bytes are not silently accepted", async () => {
  const bytes = await readFile(new URL("../../../../src/planets/earth/source/land-cover/empty.png",import.meta.url));
