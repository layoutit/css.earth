...
import { childAddresses, pageKey } from '../../../../tools/objects/geographic-pages/page-geometry.mjs';
import { prepareCoarsePageGeometry, sampleCoarsePage, trimCoarsePageRgba } from '../../../../tools/objects/geographic-pages/operations/coarse-page.mjs';
import { prepareCoarseRaster, prepareCoarseRelease } from '../../../../tools/objects/geographic-pages/operations/coarse-release.mjs';
...
test('a complete local release indexes every prepared branch and resumes without rebuilding images', async t => {
  ...
  const plan = { version: 'fixture', limits: {...COARSE_PREPARATION_LIMITS,minimumFreeBytes:1024**2}, rootCount: 2,
  ...
  const args = { plan, directory, fine, scene, assetPath: '/scenes/earth/', project: new URL('../../../../', import.meta.url) };
