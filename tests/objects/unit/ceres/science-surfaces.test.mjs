...
const anchors = {
  // The TIFF's stored origin/resolution place 270E,-30N inside cell
  // (16199,7199), whose pinned source value is 3839 meters.
  elevation: [[90, 30, 1552], [180, 0, 16202], [270, -30, 3839], [10, 80, null], [350, -80, null]],
