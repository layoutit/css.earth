...
test('Larissa keeps the published west-positive radius samples in metres', async () => {
  ...
  for (const [longitude, latitude, metres] of [[0, 0, 104894.90000000001], [90, 0, 96000.0], [180, 0, 95472.78], [270, 0, 96605.48], [0, 90, 89000.0], [0, -90, 87354.09]] as const) {
