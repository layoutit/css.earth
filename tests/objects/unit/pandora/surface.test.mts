...
const test = sourceTest('pandora');
import {readFile} from 'node:fs/promises';
import {resolve} from 'node:path';
import {loadPdsPlateShape} from '../../../../tools/objects/terrestrial-layers/obj-shape.mts';

const source = resolve(import.meta.dirname, '../../../../src/objects/pandora/source');

test('Pandora released plate mesh preserves PDS units, axes and vertex indices', async () => {
