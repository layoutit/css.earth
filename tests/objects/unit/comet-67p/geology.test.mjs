...
import {decodeVtkCategories} from '../../../../tools/objects/terrestrial-layers/vtk-categories.mjs';
import {decodeSbmtPaths, decodeSbmtLocations} from '../../../../tools/objects/terrestrial-layers/sbmt-symbols.mjs';
