...
test('Iapetus maps preserve geographic registration and observed dark terrain', async () => {
  ...
  for (const [lat,lon] of [[-28.1,267.4],[0,143.3],[-40.5,95.3],[53.4,84],[0,359.9],[0,0.1],[-80,90],[80,90]]) {
...
test('Iapetus source coordinates use the actual GeoTIFF radius and explicit validity', async () => {
  ...
  try {
    ...
    assert.equal(config.raster.observations.find(lens=>lens.id==='enhanced').validity.noData,null,
