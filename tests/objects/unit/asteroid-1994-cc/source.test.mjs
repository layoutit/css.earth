...
const root=resolve(import.meta.dirname,'../../../../src/planets/asteroid-1994-cc/source');
const read=async path=>JSON.parse(await readFile(resolve(root,path),'utf8'));
test('1994 CC Alpha retains original source pins and acquisition closure',async()=>{
 const source=await createSourceManifest({planetId:'asteroid-1994-cc',planetName:'1994 CC Alpha',sourceRoot:root});await source.verify();
