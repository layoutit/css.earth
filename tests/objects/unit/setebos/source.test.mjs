...
const root=new URL('../../../../src/planets/setebos/source/',import.meta.url);
test('Setebos radius table preserves independently derived physical-axis anchors',async()=>{
 ...
 for(const [lon,lat,metres] of [[0, 0, 27737.53493781565], [90, 0, 21630.564936199527], [0, 90, 21630.564936199527], [0, -90, 21630.564936199527]]) assert.ok(Math.abs(shape.sample(lon,lat)-metres)<.001,`${lon},${lat}`);
