...
const source=new URL('../../../../src/planets/hydra/source/',import.meta.url);
...
test('Hydra retains the released kilometre mesh and independent source anchors',async()=>{
 ...
 for(const [lon,lat,radius] of [[0,0,23423.08998108],[90,0,17528.92494202],[180,0,26039.52598572],[270,0,16517.19284058],[0,90,11417.36030579],[0,-90,11808.97712708]])
