...
test('Romulus radius table preserves independently derived physical-axis anchors',async()=>{
 ...
 for(const [lon,lat,metres] of [[0, 0, 18978.586617554007], [90, 0, 7029.106154649631], [0, 90, 7029.106154649631], [0, -90, 7029.106154649631]]) assert.ok(Math.abs(shape.sample(lon,lat)-metres)<.001,`${lon},${lat}`);
