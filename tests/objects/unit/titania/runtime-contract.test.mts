...
import runtimeDefinition from "../../../../src/planets/titania/prepared/runtime.json" with { type: "json" };
import assets from "../../../../src/planets/titania/prepared/assets.json" with { type: "json" };
import scene from "../../../../src/planets/titania/prepared/scene.json" with { type: "json" };
import lenses from "../../../../src/planets/titania/prepared/lenses.json" with { type: "json" };
import controls from "../../../../src/planets/titania/prepared/controls.json" with { type: "json" };
...
test("Titania's actual import closure has only shared runtime owners", async () => {
  const audit = await auditObjectRuntimeOwnership({ objects: OBJECTS.filter(object => object.id === "titania") });
