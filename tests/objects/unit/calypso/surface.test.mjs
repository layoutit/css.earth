...
const source = resolve(import.meta.dirname, '../../../../src/planets/calypso/source');
...
test('Calypso released plate mesh preserves PDS units, axes and vertex indices', async () => {
  ...
  for (const [longitude, latitude, expected] of [[0, 0, 16379.6], [90, 0, 9645.799559039497], [180, 0, 13725.450403395183], [270, 0, 8637.119432970661], [0, 90, 6613.199999999999], [0, -90, 6403.6]]) {
