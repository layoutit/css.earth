...
import assets from "../../../../src/objects/callisto/prepared/assets.json" with { type: "json" };
import scene from "../../../../src/objects/callisto/prepared/scene.json" with { type: "json" };
import lenses from "../../../../src/objects/callisto/prepared/lenses.json" with { type: "json" };
import text from "../../../../src/objects/callisto/prepared/text.json" with { type: "json" };
import controls from "../../../../src/objects/callisto/prepared/controls.json" with { type: "json" };
...
test("Callisto's actual import closure has only shared runtime owners", async () => {
  const audit = await auditObjectRuntimeOwnership({ objects: SCENE_OBJECTS.filter(object => object.id === "callisto") });
