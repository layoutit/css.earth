...
const root = new URL('../../../../src/planets/desdemona/source/', import.meta.url);
...
test('Desdemona retains the published axes without confusing projected and volume radii', async () => {
  ...
  for (const [lon, lat, radius] of [[0,0,45000], [90,0,27000], [180,0,45000], [270,0,27000], [0,90,27000], [0,-90,27000]]) {
