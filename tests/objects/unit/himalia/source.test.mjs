...
test('Himalia preserves approximate elongation and volume through a closed physical surface', async () => {
  ...
  for (const [lon, lat, radius] of [[0,0,98633.76271427155], [90,0,78907.01017141724], [180,0,98633.76271427155], [270,0,78907.01017141724], [0,90,78907.01017141724], [0,-90,78907.01017141724]]) {
  ...
  const a = shape.sample(0, 0) / 1000, b = shape.sample(90, 0) / 1000, c = shape.sample(0, 90) / 1000;
