/** The HD 209458 system's packages verify against their source pins. The planet's radius and orbit are the astronomy records'
...
test('the HD 209458 packages verify against their source pins', async () => {
  for (const [id, name] of [['hd-209458', 'HD 209458'], ['hd-209458b', 'HD 209458 b']] as const) {
