...
import text from "../../../../src/objects/eris/prepared/text.json" with { type: "json" };
...
test("Eris is prepared by the generic raster lane with the source-radius sphere, the Lambert lighting bank and its 2 lenses", () => {
