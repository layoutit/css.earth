...
const root = new URL('../../../../src/planets/cordelia/', import.meta.url);
...
test('Cordelia preserves the published prolate dimensions and ring-derived mass', async () => {
  ...
  for (const [lon, lat, radius] of [[0, 0, 25000], [90, 0, 18000], [180, 0, 25000], [270, 0, 18000], [0, 90, 18000], [0, -90, 18000]]) {
  ...
  const measurement = JSON.parse(await readFile(new URL('source/measurements.json', root)));
