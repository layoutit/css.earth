...
const ASTRONOMY = resolve(import.meta.dirname, '../../../../packages/astronomy/data/bodies/ce-tauri.json');
...
for (const [lensId, epochJd] of [['pionier-2016-11', 2457706.678], ['pionier-2016-12', 2457745.656]] as const) test(`${lensId}: the lens recipe states the camera the pinned astrometry and display axis imply`, async () => {
