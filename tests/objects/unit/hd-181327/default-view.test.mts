 ...
 * frame puts its display axis, celestial north, up, so the camera orbit lies in its equator and the default view sits one degree from the
 * sub-Earth point. */
import { sourceTest } from '../../source-test.mts';
const test = sourceTest('hd-181327');
