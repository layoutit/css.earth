...
const source = resolve(import.meta.dirname, '../../../../src/planets/daphnis/source');
...
test('Daphnis released plate mesh preserves PDS units, axes and vertex indices', async () => {
  ...
  for (const [longitude, latitude, expected] of [[0, 0, 5468.8], [90, 0, 4864.154814588618], [180, 0, 5550.905087061157], [270, 0, 4631.538968476371], [0, 90, 2773.8999999999996], [0, -90, 3005.1999999999994]]) {
