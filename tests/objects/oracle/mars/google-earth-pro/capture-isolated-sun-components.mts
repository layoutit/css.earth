...
import { saveScreenShot, setViewInfo } from "./controller.mts";
...
execFileSync("/usr/bin/lldb", [
  ...
  "-o", lldbSetEnvironment("CSSMARS_ORACLE_CONTRACT_LOG_V10", "/dev/null"),
  "-o", lldbSetEnvironment("CSSMARS_ORACLE_CONTRACT_UNIFORM_LOG_V10", "/dev/null"),
  "-o", lldbSetEnvironment("CSSMARS_ORACLE_CONTRACT_INSTALL_LOG_V10", "/dev/null"),
