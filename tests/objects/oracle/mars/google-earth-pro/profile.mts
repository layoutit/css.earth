...
function pose({
  ...
  rangeMeters,
  family,
}: { latitude: number; longitude: number; heading?: number; tilt: number; rangeMeters: number; family: string }) {
...
function signedSlug(value: number) {
...
export type MarsOraclePose = ReturnType<typeof pose>;
