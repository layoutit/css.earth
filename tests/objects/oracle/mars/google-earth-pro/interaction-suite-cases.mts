import { loadInteractionCorpus, type InteractionKind, type InteractionScenario } from "./interaction-corpus.mts";

const pointer = (id: string, kind: InteractionKind, atMilliseconds: number, discX: number, discY: number, clickCount = 1) =>
...
export async function interactionSuiteCases(): Promise<InteractionScenario[]> {
